...
main() {
  ...
  assert(499 == b.foo()); // //# 01: continued
  assert(500 == b.foo2()); //# 01: continued
  assert(42 == b.foo3()); // //# 01: continued
  assert(117 == b.foo4()); //# 01: continued
  assert(498 == b.foo5()); //# 01: continued
  assert(468 == b.foo6()); //# 01: continued
  assert(426 == b.foo7()); //# 01: continued
  assert(502 == b.foo8()); //# 01: continued

  assert(499 == b.fooGee()); // //# 01: continued
  assert(500 == b.fooGee2()); //# 01: continued
  assert(42 == b.fooGee3()); // //# 01: continued
  assert(117 == b.fooGee4()); //# 01: continued
  assert(498 == b.fooGee5()); //# 01: continued
  assert(468 == b.fooGee6()); //# 01: continued
  assert(426 == b.fooGee7()); //# 01: continued
  assert(502 == b.fooGee8()); //# 01: continued

  assert(1267 == b.fooIntercept());
  assert(1236 == b.fooIntercept2());
  assert(1335 == b.fooIntercept3());
  assert(1390 == b.fooIntercept4());
  assert(4362 == b.fooIntercept5());
  assert(4291 == b.fooIntercept6());
  assert(232 == b.fooIntercept7());
  assert(199 == b.fooIntercept8());

  assert(12463 == b.fooIntercept21());
  assert(12344 == b.fooIntercept22());
  assert(15364 == b.fooIntercept23());
  assert(13208 == b.fooIntercept24());
  assert(14742 == b.fooIntercept25());
  assert(14291 == b.fooIntercept26());
  assert(1768 == b.fooIntercept27());
  assert(1771 == b.fooIntercept28());
}

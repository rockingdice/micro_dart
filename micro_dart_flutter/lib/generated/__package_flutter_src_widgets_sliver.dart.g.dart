...
'package:flutter/src/widgets/sliver.dart@SliverList@': (m.Scope scope)=>({ delegate,  key}){
return SliverList(delegate:delegate, key:key);
},
...
'package:flutter/src/widgets/sliver.dart@SliverFixedExtentList@': (m.Scope scope)=>({ delegate,  itemExtent,  key}){
return SliverFixedExtentList(delegate:delegate, itemExtent:itemExtent, key:key);
},
...
'package:flutter/src/widgets/sliver.dart@SliverGrid@': (m.Scope scope)=>({ delegate,  gridDelegate,  key}){
return SliverGrid(delegate:delegate, gridDelegate:gridDelegate, key:key);
},
...
'package:flutter/src/widgets/sliver.dart@SliverMultiBoxAdaptorElement@': (m.Scope scope)=>( widget, { replaceMovedChildren}){
return SliverMultiBoxAdaptorElement(widget, replaceMovedChildren:replaceMovedChildren ?? false);
},
...
'package:flutter/src/widgets/sliver.dart@SliverOpacity@': (m.Scope scope)=>({ alwaysIncludeSemantics,  key,  opacity,  sliver}){
return SliverOpacity(alwaysIncludeSemantics:alwaysIncludeSemantics ?? false, key:key, opacity:opacity, sliver:sliver);
},
...
'package:flutter/src/widgets/sliver.dart@KeepAlive@': (m.Scope scope)=>({ child,  keepAlive,  key}){
return KeepAlive(child:child, keepAlive:keepAlive, key:key);
},

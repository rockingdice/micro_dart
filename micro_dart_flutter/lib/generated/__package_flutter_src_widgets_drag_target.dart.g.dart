...
'package:flutter/src/widgets/drag_target.dart@DraggableDetails@': (m.Scope scope)=>({ offset,  velocity,  wasAccepted}){
return DraggableDetails(offset:offset, velocity:velocity, wasAccepted:wasAccepted ?? false);
},
...
'package:flutter/src/widgets/drag_target.dart@DragTargetDetails@': (m.Scope scope)=><T>({ data,  offset}){

...
'package:flutter/src/widgets/selection_container.dart@SelectionContainer@': (m.Scope scope)=>({ child,  delegate,  key,  registrar}){
return SelectionContainer(child:child, delegate:delegate, key:key, registrar:registrar);
},
...
'package:flutter/src/widgets/selection_container.dart@SelectionRegistrarScope@': (m.Scope scope)=>({ child,  key,  registrar}){
return SelectionRegistrarScope(child:child, key:key, registrar:registrar);
},

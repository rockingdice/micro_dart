...
'package:flutter/src/animation/animations.dart@AlwaysStoppedAnimation@': (m.Scope scope)=><T>( value){
...
'package:flutter/src/animation/animations.dart@ReverseAnimation@': (m.Scope scope)=>( parent){
...
'package:flutter/src/animation/animations.dart@CurvedAnimation@': (m.Scope scope)=>({ curve,  parent,  reverseCurve}){
return CurvedAnimation(curve:curve, parent:parent, reverseCurve:reverseCurve);
},
...
'package:flutter/src/animation/animations.dart@AnimationMean@': (m.Scope scope)=>({ left,  right}){
...
'package:flutter/src/animation/animations.dart@AnimationMax@': (m.Scope scope)=><T>( first,  next){
...
'package:flutter/src/animation/animations.dart@AnimationMin@': (m.Scope scope)=><T>( first,  next){

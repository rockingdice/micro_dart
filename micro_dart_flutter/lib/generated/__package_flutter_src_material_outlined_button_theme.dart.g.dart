...
'package:flutter/src/material/outlined_button_theme.dart@OutlinedButtonTheme@': (m.Scope scope)=>({ child,  data,  key}){
return OutlinedButtonTheme(child:child, data:data, key:key);
},

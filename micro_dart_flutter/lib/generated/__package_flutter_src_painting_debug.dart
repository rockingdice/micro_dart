...
Size _ImageSizeInfo_displaySize$(ImageSizeInfo target) {
  return target.displaySize;
}

Size _ImageSizeInfo_imageSize$(ImageSizeInfo target) {
  return target.imageSize;
}

int _ImageSizeInfo_displaySizeInBytes$(ImageSizeInfo target) {
  return target.displaySizeInBytes;
}

int _ImageSizeInfo_decodedSizeInBytes$(ImageSizeInfo target) {
  return target.decodedSizeInBytes;
}

int _ImageSizeInfo_hashCode$(ImageSizeInfo target) {

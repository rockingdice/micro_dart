...
Function _SearchDelegate_searchFieldLabel$<T>(
  m.Scope scope$,
...
Function _SearchDelegate_searchFieldStyle$<T>(
  m.Scope scope$,
  SearchDelegate<T> target$,
) =>
    () {
...
Function _SearchDelegate_searchFieldDecorationTheme$<T>(
  m.Scope scope$,
  SearchDelegate<T> target$,
) =>
    () {
...
Function _SearchDelegate_keyboardType$<T>(
  m.Scope scope$,
  SearchDelegate<T> target$,
) =>
    () {
...
Function _SearchDelegate_textInputAction$<T>(
  m.Scope scope$,
  SearchDelegate<T> target$,
) =>
    () {
...
Function _SearchDelegate_query$<T>(
  m.Scope scope$,
  SearchDelegate<T> target$,
) =>
    () {
...
Function _SearchDelegate_transitionAnimation$<T>(
  m.Scope scope$,
  SearchDelegate<T> target$,
) =>
    () {

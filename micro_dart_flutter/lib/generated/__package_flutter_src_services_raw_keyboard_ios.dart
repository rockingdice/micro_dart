...
String _RawKeyEventDataIos_charactersIgnoringModifiers$(
    RawKeyEventDataIos target) {
  return target.charactersIgnoringModifiers;
}

int _RawKeyEventDataIos_keyCode$(RawKeyEventDataIos target) {
  return target.keyCode;
}

int _RawKeyEventDataIos_modifiers$(RawKeyEventDataIos target) {
...
String _RawKeyEventDataIos_keyLabel$(RawKeyEventDataIos target) {
  return target.keyLabel;
}

PhysicalKeyboardKey _RawKeyEventDataIos_physicalKey$(
    RawKeyEventDataIos target) {
  return target.physicalKey;
}

LogicalKeyboardKey _RawKeyEventDataIos_logicalKey$(RawKeyEventDataIos target) {
  return target.logicalKey;
}

int _RawKeyEventDataIos_hashCode$(RawKeyEventDataIos target) {

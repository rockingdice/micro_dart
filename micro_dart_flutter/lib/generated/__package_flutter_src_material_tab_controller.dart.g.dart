...
'package:flutter/src/material/tab_controller.dart@TabController@': (m.Scope scope)=>({ animationDuration,  initialIndex,  length,  vsync}){
return TabController(animationDuration:animationDuration, initialIndex:initialIndex ?? 0, length:length, vsync:vsync);
},
...
'package:flutter/src/material/tab_controller.dart@DefaultTabController@': (m.Scope scope)=>({ animationDuration,  child,  initialIndex,  key,  length}){
return DefaultTabController(animationDuration:animationDuration, child:child, initialIndex:initialIndex ?? 0, key:key, length:length);
},

...
return InkHighlight(borderRadius:borderRadius, color:color, controller:controller, customBorder:customBorder, fadeDuration:fadeDuration ?? _kDefaultHighlightFadeDuration, onRemoved:onRemoved == null ? null :onRemovedProxy, radius:radius, rectCallback:rectCallback == null ? null :rectCallbackProxy, referenceBox:referenceBox, shape:shape ?? BoxShape.rectangle, textDirection:textDirection);
},

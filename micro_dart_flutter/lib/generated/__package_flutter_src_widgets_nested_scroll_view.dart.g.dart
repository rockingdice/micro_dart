...
'package:flutter/src/widgets/nested_scroll_view.dart@SliverOverlapAbsorber@': (m.Scope scope)=>({ handle,  key,  sliver}){
return SliverOverlapAbsorber(handle:handle, key:key, sliver:sliver);
},
...
'package:flutter/src/widgets/nested_scroll_view.dart@RenderSliverOverlapAbsorber@': (m.Scope scope)=>({ handle,  sliver}){
...
'package:flutter/src/widgets/nested_scroll_view.dart@SliverOverlapInjector@': (m.Scope scope)=>({ handle,  key,  sliver}){
return SliverOverlapInjector(handle:handle, key:key, sliver:sliver);
},
...
'package:flutter/src/widgets/nested_scroll_view.dart@RenderSliverOverlapInjector@': (m.Scope scope)=>({ handle}){
...
'package:flutter/src/widgets/nested_scroll_view.dart@NestedScrollViewViewport@': (m.Scope scope)=>({ anchor,  axisDirection,  center,  clipBehavior,  crossAxisDirection,  handle,  key,  offset,  slivers}){
return NestedScrollViewViewport(anchor:anchor ?? 0.0, axisDirection:axisDirection ?? AxisDirection.down, center:center, clipBehavior:clipBehavior ?? Clip.hardEdge, crossAxisDirection:crossAxisDirection, handle:handle, key:key, offset:offset, slivers:slivers ?? const <Widget>[]);
},
...
'package:flutter/src/widgets/nested_scroll_view.dart@RenderNestedScrollViewViewport@': (m.Scope scope)=>({ anchor,  axisDirection,  center,  children,  clipBehavior,  crossAxisDirection,  handle,  offset}){
return RenderNestedScrollViewViewport(anchor:anchor ?? 0.0, axisDirection:axisDirection ?? AxisDirection.down, center:center, children:children, clipBehavior:clipBehavior ?? Clip.hardEdge, crossAxisDirection:crossAxisDirection, handle:handle, offset:offset);
},

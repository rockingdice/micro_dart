...
'package:flutter/src/foundation/licenses.dart@LicenseParagraph@': (m.Scope scope)=>( text,  indent){
...
'package:flutter/src/foundation/licenses.dart@LicenseEntryWithLineBreaks@': (m.Scope scope)=>( packages,  text){

...
'package:flutter/src/rendering/selection.dart@SelectedContent@': (m.Scope scope)=>SelectedContent,
...
'package:flutter/src/rendering/selection.dart@SelectWordSelectionEvent@': (m.Scope scope)=>SelectWordSelectionEvent,
...
'package:flutter/src/rendering/selection.dart@GranularlyExtendSelectionEvent@': (m.Scope scope)=>GranularlyExtendSelectionEvent,
...
'package:flutter/src/rendering/selection.dart@DirectionallyExtendSelectionEvent@': (m.Scope scope)=>DirectionallyExtendSelectionEvent,
...
'package:flutter/src/rendering/selection.dart@SelectionGeometry@': (m.Scope scope)=>SelectionGeometry,
...
'package:flutter/src/rendering/selection.dart@SelectionPoint@': (m.Scope scope)=>SelectionPoint,

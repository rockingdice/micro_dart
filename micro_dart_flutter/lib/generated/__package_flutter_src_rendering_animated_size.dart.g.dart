...
'package:flutter/src/rendering/animated_size.dart@RenderAnimatedSize@': (m.Scope scope)=>({ alignment,  child,  clipBehavior,  curve,  duration,  reverseDuration,  textDirection,  vsync}){
return RenderAnimatedSize(alignment:alignment ?? Alignment.center, child:child, clipBehavior:clipBehavior ?? Clip.hardEdge, curve:curve ?? Curves.linear, duration:duration, reverseDuration:reverseDuration, textDirection:textDirection, vsync:vsync);
},

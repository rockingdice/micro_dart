...
'package:flutter/src/widgets/transitions.dart@SlideTransition@': (m.Scope scope)=>({ child,  key,  position,  textDirection,  transformHitTests}){
return SlideTransition(child:child, key:key, position:position, textDirection:textDirection, transformHitTests:transformHitTests ?? true);
},
...
'package:flutter/src/widgets/transitions.dart@ScaleTransition@': (m.Scope scope)=>({ alignment,  child,  filterQuality,  key,  scale}){
return ScaleTransition(alignment:alignment ?? Alignment.center, child:child, filterQuality:filterQuality, key:key, scale:scale);
},
...
'package:flutter/src/widgets/transitions.dart@RotationTransition@': (m.Scope scope)=>({ alignment,  child,  filterQuality,  key,  turns}){
return RotationTransition(alignment:alignment ?? Alignment.center, child:child, filterQuality:filterQuality, key:key, turns:turns);
},
...
'package:flutter/src/widgets/transitions.dart@SizeTransition@': (m.Scope scope)=>({ axis,  axisAlignment,  child,  key,  sizeFactor}){
return SizeTransition(axis:axis ?? Axis.vertical, axisAlignment:axisAlignment ?? 0.0, child:child, key:key, sizeFactor:sizeFactor);
},
...
'package:flutter/src/widgets/transitions.dart@FadeTransition@': (m.Scope scope)=>({ alwaysIncludeSemantics,  child,  key,  opacity}){
return FadeTransition(alwaysIncludeSemantics:alwaysIncludeSemantics ?? false, child:child, key:key, opacity:opacity);
},
...
'package:flutter/src/widgets/transitions.dart@SliverFadeTransition@': (m.Scope scope)=>({ alwaysIncludeSemantics,  key,  opacity,  sliver}){
return SliverFadeTransition(alwaysIncludeSemantics:alwaysIncludeSemantics ?? false, key:key, opacity:opacity, sliver:sliver);
},
...
'package:flutter/src/widgets/transitions.dart@PositionedTransition@': (m.Scope scope)=>({ child,  key,  rect}){
...
'package:flutter/src/widgets/transitions.dart@RelativePositionedTransition@': (m.Scope scope)=>({ child,  key,  rect,  size}){
return RelativePositionedTransition(child:child, key:key, rect:rect, size:size);
},
...
'package:flutter/src/widgets/transitions.dart@DecoratedBoxTransition@': (m.Scope scope)=>({ child,  decoration,  key,  position}){
return DecoratedBoxTransition(child:child, decoration:decoration, key:key, position:position ?? DecorationPosition.background);
},
...
'package:flutter/src/widgets/transitions.dart@AlignTransition@': (m.Scope scope)=>({ alignment,  child,  heightFactor,  key,  widthFactor}){
return AlignTransition(alignment:alignment, child:child, heightFactor:heightFactor, key:key, widthFactor:widthFactor);
},
...
'package:flutter/src/widgets/transitions.dart@DefaultTextStyleTransition@': (m.Scope scope)=>({ child,  key,  maxLines,  overflow,  softWrap,  style,  textAlign}){
return DefaultTextStyleTransition(child:child, key:key, maxLines:maxLines, overflow:overflow ?? TextOverflow.clip, softWrap:softWrap ?? true, style:style, textAlign:textAlign);
},

...
'package:flutter/src/semantics/binding.dart@SemanticsActionEvent@': (m.Scope scope)=>({ arguments,  nodeId,  type}){
return SemanticsActionEvent(arguments:arguments, nodeId:nodeId, type:type);
},

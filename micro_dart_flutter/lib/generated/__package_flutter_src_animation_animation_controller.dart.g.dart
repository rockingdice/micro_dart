...
'package:flutter/src/animation/animation_controller.dart@AnimationController@': (m.Scope scope)=>({ animationBehavior,  debugLabel,  duration,  lowerBound,  reverseDuration,  upperBound,  value,  vsync}){
return AnimationController(animationBehavior:animationBehavior ?? AnimationBehavior.normal, debugLabel:debugLabel, duration:duration, lowerBound:lowerBound ?? 0.0, reverseDuration:reverseDuration, upperBound:upperBound ?? 1.0, value:value, vsync:vsync);
},

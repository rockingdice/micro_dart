...
'package:flutter/src/material/adaptive_text_selection_toolbar.dart@AdaptiveTextSelectionToolbar@': (m.Scope scope)=>({ anchors,  children,  key}){
return AdaptiveTextSelectionToolbar(anchors:anchors, children:children, key:key);
},

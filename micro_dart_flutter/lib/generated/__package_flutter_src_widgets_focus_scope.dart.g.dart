...
'package:flutter/src/widgets/focus_scope.dart@ExcludeFocus@': (m.Scope scope)=>({ child,  excluding,  key}){
return ExcludeFocus(child:child, excluding:excluding ?? true, key:key);
},

...
bool _OffsetBase_isFinite$(OffsetBase target) {
  return target.isFinite;
}

int _OffsetBase_hashCode$(OffsetBase target) {
...
double _Offset_dx$(Offset target) {
  return target.dx;
}

double _Offset_dy$(Offset target) {
  return target.dy;
}

double _Offset_distance$(Offset target) {
  return target.distance;
}

double _Offset_distanceSquared$(Offset target) {
  return target.distanceSquared;
}

double _Offset_direction$(Offset target) {
  return target.direction;
}

int _Offset_hashCode$(Offset target) {
  return target.hashCode;
}
...
double _Size_width$(Size target) {
  return target.width;
}

double _Size_height$(Size target) {
  return target.height;
}

double _Size_aspectRatio$(Size target) {
  return target.aspectRatio;
}

bool _Size_isEmpty$(Size target) {
  return target.isEmpty;
}

double _Size_shortestSide$(Size target) {
  return target.shortestSide;
}

double _Size_longestSide$(Size target) {
  return target.longestSide;
}

Size _Size_flipped$(Size target) {
  return target.flipped;
}

int _Size_hashCode$(Size target) {
  return target.hashCode;
}
...
double _Rect_top$(Rect target) {
  return target.top;
}

double _Rect_right$(Rect target) {
  return target.right;
}

double _Rect_bottom$(Rect target) {
...
double _Rect_width$(Rect target) {
  return target.width;
}

double _Rect_height$(Rect target) {
  return target.height;
}

Size _Rect_size$(Rect target) {
  return target.size;
}

bool _Rect_hasNaN$(Rect target) {
  return target.hasNaN;
}

bool _Rect_isInfinite$(Rect target) {
  return target.isInfinite;
}

bool _Rect_isFinite$(Rect target) {
  return target.isFinite;
}

bool _Rect_isEmpty$(Rect target) {
  return target.isEmpty;
}

double _Rect_shortestSide$(Rect target) {
  return target.shortestSide;
}

double _Rect_longestSide$(Rect target) {
  return target.longestSide;
}

Offset _Rect_topLeft$(Rect target) {
  return target.topLeft;
}

Offset _Rect_topCenter$(Rect target) {
  return target.topCenter;
}

Offset _Rect_topRight$(Rect target) {
  return target.topRight;
}

Offset _Rect_centerLeft$(Rect target) {
  return target.centerLeft;
}

Offset _Rect_center$(Rect target) {
  return target.center;
}

Offset _Rect_centerRight$(Rect target) {
  return target.centerRight;
}

Offset _Rect_bottomLeft$(Rect target) {
  return target.bottomLeft;
}

Offset _Rect_bottomCenter$(Rect target) {
  return target.bottomCenter;
}

Offset _Rect_bottomRight$(Rect target) {
  return target.bottomRight;
}

int _Rect_hashCode$(Rect target) {
  return target.hashCode;
}
...
double _Radius_y$(Radius target) {
  return target.y;
}
...
int _Radius_hashCode$(Radius target) {
  return target.hashCode;
}
...
double _RRect_top$(RRect target) {
  return target.top;
}

double _RRect_right$(RRect target) {
  return target.right;
}

double _RRect_bottom$(RRect target) {
  return target.bottom;
}

double _RRect_tlRadiusX$(RRect target) {
  return target.tlRadiusX;
}

double _RRect_tlRadiusY$(RRect target) {
  return target.tlRadiusY;
}

double _RRect_trRadiusX$(RRect target) {
  return target.trRadiusX;
}

double _RRect_trRadiusY$(RRect target) {
  return target.trRadiusY;
}

double _RRect_brRadiusX$(RRect target) {
  return target.brRadiusX;
}

double _RRect_brRadiusY$(RRect target) {
  return target.brRadiusY;
}

double _RRect_blRadiusX$(RRect target) {
  return target.blRadiusX;
}

double _RRect_blRadiusY$(RRect target) {
...
Radius _RRect_tlRadius$(RRect target) {
  return target.tlRadius;
}

Radius _RRect_trRadius$(RRect target) {
  return target.trRadius;
}

Radius _RRect_brRadius$(RRect target) {
  return target.brRadius;
}

Radius _RRect_blRadius$(RRect target) {
  return target.blRadius;
}

double _RRect_width$(RRect target) {
  return target.width;
}

double _RRect_height$(RRect target) {
  return target.height;
}

Rect _RRect_outerRect$(RRect target) {
  return target.outerRect;
}

Rect _RRect_safeInnerRect$(RRect target) {
  return target.safeInnerRect;
}

Rect _RRect_middleRect$(RRect target) {
  return target.middleRect;
}

Rect _RRect_wideMiddleRect$(RRect target) {
  return target.wideMiddleRect;
}

Rect _RRect_tallMiddleRect$(RRect target) {
  return target.tallMiddleRect;
}

bool _RRect_isEmpty$(RRect target) {
  return target.isEmpty;
}

bool _RRect_isFinite$(RRect target) {
  return target.isFinite;
}

bool _RRect_isRect$(RRect target) {
  return target.isRect;
}

bool _RRect_isStadium$(RRect target) {
  return target.isStadium;
}

bool _RRect_isEllipse$(RRect target) {
  return target.isEllipse;
}

bool _RRect_isCircle$(RRect target) {
  return target.isCircle;
}

double _RRect_shortestSide$(RRect target) {
  return target.shortestSide;
}

double _RRect_longestSide$(RRect target) {
  return target.longestSide;
}

bool _RRect_hasNaN$(RRect target) {
  return target.hasNaN;
}

Offset _RRect_center$(RRect target) {
  return target.center;
}

int _RRect_hashCode$(RRect target) {
  return target.hashCode;
}
...
double _RSTransform_ssin$(RSTransform target) {
  return target.ssin;
}

double _RSTransform_tx$(RSTransform target) {
  return target.tx;
}

double _RSTransform_ty$(RSTransform target) {
  return target.ty;
}
...
KeyEventType _KeyData_type$(KeyData target) {
  return target.type;
}

int _KeyData_physical$(KeyData target) {
  return target.physical;
}

int _KeyData_logical$(KeyData target) {
  return target.logical;
}

String? _KeyData_character$(KeyData target) {
  return target.character;
}

bool _KeyData_synthesized$(KeyData target) {
...
int _Color_alpha$(Color target) {
  return target.alpha;
}

double _Color_opacity$(Color target) {
  return target.opacity;
}

int _Color_red$(Color target) {
  return target.red;
}

int _Color_green$(Color target) {
  return target.green;
}

int _Color_blue$(Color target) {
  return target.blue;
}

int _Color_hashCode$(Color target) {
  return target.hashCode;
}
...
bool _Paint_isAntiAlias$(Paint target) {
...
Color _Paint_color$(Paint target) {
  return target.color;
}
...
BlendMode _Paint_blendMode$(Paint target) {
...
PaintingStyle _Paint_style$(Paint target) {
  return target.style;
}
...
double _Paint_strokeWidth$(Paint target) {
...
StrokeCap _Paint_strokeCap$(Paint target) {
...
StrokeJoin _Paint_strokeJoin$(Paint target) {
...
double _Paint_strokeMiterLimit$(Paint target) {
...
MaskFilter? _Paint_maskFilter$(Paint target) {
...
FilterQuality _Paint_filterQuality$(Paint target) {
...
Shader? _Paint_shader$(Paint target) {
...
ColorFilter? _Paint_colorFilter$(Paint target) {
...
ImageFilter? _Paint_imageFilter$(Paint target) {
...
bool _Paint_invertColors$(Paint target) {
...
Function _Image_onCreate_set$(m.Scope scope) => (m.FunctionPointer? _onCreate) {
...
int _Image_width$(Image target) {
  return target.width;
}

int _Image_height$(Image target) {
  return target.height;
}

bool _Image_debugDisposed$(Image target) {
  return target.debugDisposed;
}

ColorSpace _Image_colorSpace$(Image target) {
...
Image _FrameInfo_image$(FrameInfo target) {
  return target.image;
}
...
int _Codec_repetitionCount$(Codec target) {
...
int? _TargetImageSize_height$(TargetImageSize target) {
  return target.height;
}
...
Offset _Tangent_vector$(Tangent target) {
  return target.vector;
}

double _Tangent_angle$(Tangent target) {
  return target.angle;
}
...
bool _PathMetric_isClosed$(PathMetric target) {
  return target.isClosed;
}

int _PathMetric_contourIndex$(PathMetric target) {
...
bool _Picture_debugDisposed$(Picture target) {
  return target.debugDisposed;
}

int _Picture_approximateBytesUsed$(Picture target) {
...
Offset _Shadow_offset$(Shadow target) {
  return target.offset;
}

double _Shadow_blurRadius$(Shadow target) {
  return target.blurRadius;
}

double _Shadow_blurSigma$(Shadow target) {
  return target.blurSigma;
}

int _Shadow_hashCode$(Shadow target) {
  return target.hashCode;
}
...
bool _ImmutableBuffer_debugDisposed$(ImmutableBuffer target) {
  return target.debugDisposed;
}
...
int _ImageDescriptor_height$(ImageDescriptor target) {
  return target.height;
}

int _ImageDescriptor_bytesPerPixel$(ImageDescriptor target) {
...
StackTrace? _PictureRasterizationException_stack$(
    PictureRasterizationException target) {
  return target.stack;
}
...
Function _decodeImageFromPixels$(m.Scope scope) => (
      ...
      decodeImageFromPixels(
        ...
        format,
        callbackProxy,
        allowUpscaling: allowUpscaling == null ? true : allowUpscaling,
        rowBytes: rowBytes,
...
void Function()? _PlatformDispatcher_onPlatformConfigurationChanged$(
...
Iterable<FlutterView> _PlatformDispatcher_views$(PlatformDispatcher target) {
  return target.views;
}

FlutterView? _PlatformDispatcher_implicitView$(PlatformDispatcher target) {
  return target.implicitView;
}

void Function()? _PlatformDispatcher_onMetricsChanged$(
    PlatformDispatcher target) {
...
void Function(Duration)? _PlatformDispatcher_onBeginFrame$(
    PlatformDispatcher target) {
...
void Function()? _PlatformDispatcher_onDrawFrame$(PlatformDispatcher target) {
...
void Function(PointerDataPacket)? _PlatformDispatcher_onPointerDataPacket$(
    PlatformDispatcher target) {
...
bool Function(KeyData)? _PlatformDispatcher_onKeyData$(
    PlatformDispatcher target) {
...
void Function(List<FrameTiming>)? _PlatformDispatcher_onReportTimings$(
    PlatformDispatcher target) {
...
Function _PlatformDispatcher_onReportTimings_set$(
  ...
  PlatformDispatcher target,
    ...
    (m.FunctionPointer? callback) {
      void callbackProxy(List<FrameTiming> callback_timings) =>
          scope.engine.callFunctionPointer(
            scope,
            callback!,
            [callback_timings],
...
void Function(String, ByteData?, void Function(ByteData?)?)?
    _PlatformDispatcher_onPlatformMessage$(PlatformDispatcher target) {
...
void Function()? _PlatformDispatcher_onAccessibilityFeaturesChanged$(
    PlatformDispatcher target) {
...
Locale _PlatformDispatcher_locale$(PlatformDispatcher target) {
  return target.locale;
}

List<Locale> _PlatformDispatcher_locales$(PlatformDispatcher target) {
  return target.locales;
}

void Function()? _PlatformDispatcher_onLocaleChanged$(
    PlatformDispatcher target) {
...
String _PlatformDispatcher_initialLifecycleState$(PlatformDispatcher target) {
  return target.initialLifecycleState;
}

bool _PlatformDispatcher_alwaysUse24HourFormat$(PlatformDispatcher target) {
  return target.alwaysUse24HourFormat;
}

double _PlatformDispatcher_textScaleFactor$(PlatformDispatcher target) {
  return target.textScaleFactor;
}

void Function()? _PlatformDispatcher_onTextScaleFactorChanged$(
    PlatformDispatcher target) {
...
bool _PlatformDispatcher_nativeSpellCheckServiceDefined$(
    PlatformDispatcher target) {
  return target.nativeSpellCheckServiceDefined;
}

bool _PlatformDispatcher_brieflyShowPassword$(PlatformDispatcher target) {
  return target.brieflyShowPassword;
}

Brightness _PlatformDispatcher_platformBrightness$(PlatformDispatcher target) {
  return target.platformBrightness;
}

void Function()? _PlatformDispatcher_onPlatformBrightnessChanged$(
    PlatformDispatcher target) {
...
String? _PlatformDispatcher_systemFontFamily$(PlatformDispatcher target) {
  return target.systemFontFamily;
}

void Function()? _PlatformDispatcher_onSystemFontFamilyChanged$(
    PlatformDispatcher target) {
...
bool _PlatformDispatcher_semanticsEnabled$(PlatformDispatcher target) {
  return target.semanticsEnabled;
}

void Function()? _PlatformDispatcher_onSemanticsEnabledChanged$(
    PlatformDispatcher target) {
...
void Function(int, SemanticsAction, ByteData?)?
    _PlatformDispatcher_onSemanticsAction$(PlatformDispatcher target) {
...
FrameData _PlatformDispatcher_frameData$(PlatformDispatcher target) {
  return target.frameData;
}

void Function()? _PlatformDispatcher_onFrameDataChanged$(
    PlatformDispatcher target) {
...
bool Function(Object, StackTrace)? _PlatformDispatcher_onError$(
    PlatformDispatcher target) {
...
String _PlatformDispatcher_defaultRouteName$(PlatformDispatcher target) {
...
Duration _FrameTiming_rasterDuration$(FrameTiming target) {
  return target.rasterDuration;
}

Duration _FrameTiming_vsyncOverhead$(FrameTiming target) {
  return target.vsyncOverhead;
}

Duration _FrameTiming_totalSpan$(FrameTiming target) {
  return target.totalSpan;
}

int _FrameTiming_layerCacheCount$(FrameTiming target) {
  return target.layerCacheCount;
}

int _FrameTiming_layerCacheBytes$(FrameTiming target) {
  return target.layerCacheBytes;
}

double _FrameTiming_layerCacheMegabytes$(FrameTiming target) {
  return target.layerCacheMegabytes;
}

int _FrameTiming_pictureCacheCount$(FrameTiming target) {
  return target.pictureCacheCount;
}

int _FrameTiming_pictureCacheBytes$(FrameTiming target) {
  return target.pictureCacheBytes;
}

double _FrameTiming_pictureCacheMegabytes$(FrameTiming target) {
  return target.pictureCacheMegabytes;
}

int _FrameTiming_frameNumber$(FrameTiming target) {
...
double _ViewPadding_top$(ViewPadding target) {
  return target.top;
}

double _ViewPadding_right$(ViewPadding target) {
  return target.right;
}

double _ViewPadding_bottom$(ViewPadding target) {
  return target.bottom;
}
...
DisplayFeatureType _DisplayFeature_type$(DisplayFeature target) {
  return target.type;
}

DisplayFeatureState _DisplayFeature_state$(DisplayFeature target) {
  return target.state;
}

int _DisplayFeature_hashCode$(DisplayFeature target) {
  return target.hashCode;
}
...
String _Locale_languageCode$(Locale target) {
  return target.languageCode;
}

String? _Locale_countryCode$(Locale target) {
  return target.countryCode;
}

int _Locale_hashCode$(Locale target) {
  return target.hashCode;
}
...
Duration _PointerData_timeStamp$(PointerData target) {
  return target.timeStamp;
}

PointerChange _PointerData_change$(PointerData target) {
  return target.change;
}

PointerDeviceKind _PointerData_kind$(PointerData target) {
  return target.kind;
}

PointerSignalKind? _PointerData_signalKind$(PointerData target) {
  return target.signalKind;
}

int _PointerData_device$(PointerData target) {
  return target.device;
}

int _PointerData_pointerIdentifier$(PointerData target) {
  return target.pointerIdentifier;
}

double _PointerData_physicalX$(PointerData target) {
  return target.physicalX;
}

double _PointerData_physicalY$(PointerData target) {
  return target.physicalY;
}

double _PointerData_physicalDeltaX$(PointerData target) {
  return target.physicalDeltaX;
}

double _PointerData_physicalDeltaY$(PointerData target) {
  return target.physicalDeltaY;
}

int _PointerData_buttons$(PointerData target) {
  return target.buttons;
}

bool _PointerData_obscured$(PointerData target) {
  return target.obscured;
}

bool _PointerData_synthesized$(PointerData target) {
  return target.synthesized;
}

double _PointerData_pressure$(PointerData target) {
  return target.pressure;
}

double _PointerData_pressureMin$(PointerData target) {
  return target.pressureMin;
}

double _PointerData_pressureMax$(PointerData target) {
  return target.pressureMax;
}

double _PointerData_distance$(PointerData target) {
  return target.distance;
}

double _PointerData_distanceMax$(PointerData target) {
  return target.distanceMax;
}

double _PointerData_size$(PointerData target) {
  return target.size;
}

double _PointerData_radiusMajor$(PointerData target) {
  return target.radiusMajor;
}

double _PointerData_radiusMinor$(PointerData target) {
  return target.radiusMinor;
}

double _PointerData_radiusMin$(PointerData target) {
  return target.radiusMin;
}

double _PointerData_radiusMax$(PointerData target) {
  return target.radiusMax;
}

double _PointerData_orientation$(PointerData target) {
  return target.orientation;
}

double _PointerData_tilt$(PointerData target) {
  return target.tilt;
}

int _PointerData_platformData$(PointerData target) {
  return target.platformData;
}

double _PointerData_scrollDeltaX$(PointerData target) {
  return target.scrollDeltaX;
}

double _PointerData_scrollDeltaY$(PointerData target) {
  return target.scrollDeltaY;
}

double _PointerData_panX$(PointerData target) {
  return target.panX;
}

double _PointerData_panY$(PointerData target) {
  return target.panY;
}

double _PointerData_panDeltaX$(PointerData target) {
  return target.panDeltaX;
}

double _PointerData_panDeltaY$(PointerData target) {
  return target.panDeltaY;
}

double _PointerData_scale$(PointerData target) {
  return target.scale;
}

double _PointerData_rotation$(PointerData target) {
  return target.rotation;
}

PointerPreferredStylusAuxiliaryAction
    _PointerData_preferredStylusAuxiliaryAction$(PointerData target) {
...
int _FontWeight_value$(FontWeight target) {
  return target.value;
}
...
int _FontFeature_value$(FontFeature target) {
  return target.value;
}

int _FontFeature_hashCode$(FontFeature target) {
  return target.hashCode;
}
...
double _FontVariation_value$(FontVariation target) {
  return target.value;
}

int _FontVariation_hashCode$(FontVariation target) {
  return target.hashCode;
}
...
int _TextDecoration_hashCode$(TextDecoration target) {
  return target.hashCode;
}
...
bool _TextHeightBehavior_applyHeightToLastDescent$(TextHeightBehavior target) {
  return target.applyHeightToLastDescent;
}

TextLeadingDistribution _TextHeightBehavior_leadingDistribution$(
    TextHeightBehavior target) {
  return target.leadingDistribution;
}

int _TextHeightBehavior_hashCode$(TextHeightBehavior target) {
  return target.hashCode;
}
...
double _TextBox_top$(TextBox target) {
  return target.top;
}

double _TextBox_right$(TextBox target) {
  return target.right;
}

double _TextBox_bottom$(TextBox target) {
  return target.bottom;
}

TextDirection _TextBox_direction$(TextBox target) {
  return target.direction;
}

double _TextBox_start$(TextBox target) {
  return target.start;
}

double _TextBox_end$(TextBox target) {
  return target.end;
}

int _TextBox_hashCode$(TextBox target) {
  return target.hashCode;
}
...
TextAffinity _TextPosition_affinity$(TextPosition target) {
  return target.affinity;
}

int _TextPosition_hashCode$(TextPosition target) {
  return target.hashCode;
}
...
int _TextRange_start$(TextRange target) {
  return target.start;
}

int _TextRange_end$(TextRange target) {
  return target.end;
}

bool _TextRange_isValid$(TextRange target) {
  return target.isValid;
}

bool _TextRange_isCollapsed$(TextRange target) {
  return target.isCollapsed;
}

bool _TextRange_isNormalized$(TextRange target) {
  return target.isNormalized;
}

int _TextRange_hashCode$(TextRange target) {
  return target.hashCode;
}
...
int _ParagraphConstraints_hashCode$(ParagraphConstraints target) {
  return target.hashCode;
}
...
double _LineMetrics_ascent$(LineMetrics target) {
  return target.ascent;
}

double _LineMetrics_descent$(LineMetrics target) {
  return target.descent;
}

double _LineMetrics_unscaledAscent$(LineMetrics target) {
  return target.unscaledAscent;
}

double _LineMetrics_height$(LineMetrics target) {
  return target.height;
}

double _LineMetrics_width$(LineMetrics target) {
  return target.width;
}

double _LineMetrics_left$(LineMetrics target) {
  return target.left;
}

double _LineMetrics_baseline$(LineMetrics target) {
  return target.baseline;
}

int _LineMetrics_lineNumber$(LineMetrics target) {
  return target.lineNumber;
}

int _LineMetrics_hashCode$(LineMetrics target) {
  return target.hashCode;
}
...
double _Paragraph_height$(Paragraph target) {
  return target.height;
}

double _Paragraph_longestLine$(Paragraph target) {
  return target.longestLine;
}

double _Paragraph_minIntrinsicWidth$(Paragraph target) {
  return target.minIntrinsicWidth;
}

double _Paragraph_maxIntrinsicWidth$(Paragraph target) {
  return target.maxIntrinsicWidth;
}

double _Paragraph_alphabeticBaseline$(Paragraph target) {
  return target.alphabeticBaseline;
}

double _Paragraph_ideographicBaseline$(Paragraph target) {
  return target.ideographicBaseline;
}

bool _Paragraph_didExceedMaxLines$(Paragraph target) {
  return target.didExceedMaxLines;
}

bool _Paragraph_debugDisposed$(Paragraph target) {
  return target.debugDisposed;
}
...
List<double> _ParagraphBuilder_placeholderScales$(ParagraphBuilder target) {
...
PlatformDispatcher _FlutterView_platformDispatcher$(FlutterView target) {
  return target.platformDispatcher;
}

double _FlutterView_devicePixelRatio$(FlutterView target) {
  return target.devicePixelRatio;
}

Rect _FlutterView_physicalGeometry$(FlutterView target) {
  return target.physicalGeometry;
}

Size _FlutterView_physicalSize$(FlutterView target) {
  return target.physicalSize;
}

ViewPadding _FlutterView_viewInsets$(FlutterView target) {
  return target.viewInsets;
}

ViewPadding _FlutterView_viewPadding$(FlutterView target) {
  return target.viewPadding;
}

ViewPadding _FlutterView_systemGestureInsets$(FlutterView target) {
  return target.systemGestureInsets;
}

ViewPadding _FlutterView_padding$(FlutterView target) {
  return target.padding;
}

GestureSettings _FlutterView_gestureSettings$(FlutterView target) {
  return target.gestureSettings;
}

List<DisplayFeature> _FlutterView_displayFeatures$(FlutterView target) {
...
bool _AccessibilityFeatures_invertColors$(AccessibilityFeatures target) {
  return target.invertColors;
}

bool _AccessibilityFeatures_disableAnimations$(AccessibilityFeatures target) {
  return target.disableAnimations;
}

bool _AccessibilityFeatures_boldText$(AccessibilityFeatures target) {
  return target.boldText;
}

bool _AccessibilityFeatures_reduceMotion$(AccessibilityFeatures target) {
  return target.reduceMotion;
}

bool _AccessibilityFeatures_highContrast$(AccessibilityFeatures target) {
  return target.highContrast;
}

bool _AccessibilityFeatures_onOffSwitchLabels$(AccessibilityFeatures target) {
  return target.onOffSwitchLabels;
}

int _AccessibilityFeatures_hashCode$(AccessibilityFeatures target) {
  return target.hashCode;
}
...
double? _GestureSettings_physicalDoubleTapSlop$(GestureSettings target) {
  return target.physicalDoubleTapSlop;
}

int _GestureSettings_hashCode$(GestureSettings target) {
  return target.hashCode;
}

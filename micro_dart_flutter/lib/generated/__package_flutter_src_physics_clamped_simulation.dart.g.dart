...
'package:flutter/src/physics/clamped_simulation.dart@ClampedSimulation@': (m.Scope scope)=>( simulation, { dxMax,  dxMin,  xMax,  xMin}){
return ClampedSimulation(simulation, dxMax:dxMax ?? double.infinity, dxMin:dxMin ?? double.negativeInfinity, xMax:xMax ?? double.infinity, xMin:xMin ?? double.negativeInfinity);
},

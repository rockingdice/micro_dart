...
bool _RestorationManager_isReplacing$(RestorationManager target) {
...
bool _RestorationBucket_isReplacing$(RestorationBucket target) {
  return target.isReplacing;
}

String _RestorationBucket_restorationId$(RestorationBucket target) {

...
'dart:math@Point@-': (m.Scope scope, Point target)=>(other)=> target - other,
'dart:math@Point@*': (m.Scope scope, Point target)=>(other)=> target * other,
'dart:math@Point@distanceTo': (m.Scope scope, Point target)=>target.distanceTo,
'dart:math@Point@squaredDistanceTo': (m.Scope scope, Point target)=>target.squaredDistanceTo,
...
'dart:math@Random@nextInt': (m.Scope scope, Random target)=>target.nextInt,
'dart:math@Random@nextDouble': (m.Scope scope, Random target)=>target.nextDouble,
'dart:math@Random@nextBool': (m.Scope scope, Random target)=>target.nextBool,
'dart:math@Rectangle@#as': (m.Scope scope, target)=>()=>target as Rectangle,
'dart:math@Rectangle@#is': (m.Scope scope, target)=>()=>target is Rectangle,
'dart:math@Rectangle@left': (m.Scope scope, Rectangle target)=>target.left,
...
'dart:math@MutableRectangle@left': (m.Scope scope, MutableRectangle target)=>target.left,
'dart:math@MutableRectangle@left:set': (m.Scope scope, MutableRectangle target)=>(other)=>target.left=other,
'dart:math@MutableRectangle@top': (m.Scope scope, MutableRectangle target)=>target.top,
'dart:math@MutableRectangle@top:set': (m.Scope scope, MutableRectangle target)=>(other)=>target.top=other,
'dart:math@MutableRectangle@width': (m.Scope scope, MutableRectangle target)=>target.width,

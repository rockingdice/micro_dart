...
'package:flutter/src/gestures/force_press.dart@ForcePressDetails@': (m.Scope scope)=>({ globalPosition,  localPosition,  pressure}){
return ForcePressDetails(globalPosition:globalPosition, localPosition:localPosition, pressure:pressure);
},

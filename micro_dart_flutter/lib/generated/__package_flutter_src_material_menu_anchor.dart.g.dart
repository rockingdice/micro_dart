...
'package:flutter/src/material/menu_anchor.dart@MenuBar@': (m.Scope scope)=>({ children,  clipBehavior,  controller,  key,  style}){
return MenuBar(children:children, clipBehavior:clipBehavior ?? Clip.none, controller:controller, key:key, style:style);
},
...
'package:flutter/src/material/menu_anchor.dart@DismissMenuAction@': (m.Scope scope)=>({ controller}){
...
return MenuAcceleratorLabel(label, builder:builder == null ? MenuAcceleratorLabel.defaultLabelBuilder :builderProxy, key:key);
},

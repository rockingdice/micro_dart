...
'package:flutter/src/widgets/semantics_debugger.dart@SemanticsDebugger@': (m.Scope scope)=>({ child,  key,  labelStyle}){
return SemanticsDebugger(child:child, key:key, labelStyle:labelStyle ?? const TextStyle(color: Color(0xFF000000), fontSize: 10.0, height: 0.8));
},

...
Function _Accumulator__$(m.Scope scope$) => ([int? _value]) {
      if (_value == null) {
        return Accumulator();
      }
...
Function _InlineSpanSemanticsInformation_semanticsLabel$(
  m.Scope scope$,
  InlineSpanSemanticsInformation target$,
) =>
    () {
...
Function _InlineSpanSemanticsInformation_recognizer$(
  m.Scope scope$,
  InlineSpanSemanticsInformation target$,
) =>
    () {
...
Function _InlineSpanSemanticsInformation_isPlaceholder$(
  m.Scope scope$,
  InlineSpanSemanticsInformation target$,
) =>
    () {
...
Function _InlineSpanSemanticsInformation_requiresOwnNode$(
  m.Scope scope$,
  InlineSpanSemanticsInformation target$,
) =>
    () {
...
Function _InlineSpanSemanticsInformation_stringAttributes$(
  m.Scope scope$,
  InlineSpanSemanticsInformation target$,
) =>
    () {
...
Function _InlineSpanSemanticsInformation_hashCode$(
  m.Scope scope$,
  InlineSpanSemanticsInformation target$,
) =>
    () {
...
Function _InlineSpanSemanticsInformation__$(m.Scope scope$) => (
      String text, {
      bool? isPlaceholder,

...
'package:flutter/src/widgets/sliver_persistent_header.dart@SliverPersistentHeader@': (m.Scope scope)=>({ delegate,  floating,  key,  pinned}){
return SliverPersistentHeader(delegate:delegate, floating:floating ?? false, key:key, pinned:pinned ?? false);
},

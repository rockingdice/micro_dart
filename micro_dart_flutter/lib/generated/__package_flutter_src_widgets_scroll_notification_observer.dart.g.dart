...
'package:flutter/src/widgets/scroll_notification_observer.dart@ScrollNotificationObserver@': (m.Scope scope)=>({ child,  key}){
return ScrollNotificationObserver(child:child, key:key);
},

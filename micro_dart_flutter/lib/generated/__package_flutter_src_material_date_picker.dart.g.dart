...
'package:flutter/src/material/date_picker.dart@DateRangePickerDialog@': (m.Scope scope)=>({ cancelText,  confirmText,  currentDate,  errorFormatText,  errorInvalidRangeText,  errorInvalidText,  fieldEndHintText,  fieldEndLabelText,  fieldStartHintText,  fieldStartLabelText,  firstDate,  helpText,  initialDateRange,  initialEntryMode,  key,  keyboardType,  lastDate,  restorationId,  saveText}){
return DateRangePickerDialog(cancelText:cancelText, confirmText:confirmText, currentDate:currentDate, errorFormatText:errorFormatText, errorInvalidRangeText:errorInvalidRangeText, errorInvalidText:errorInvalidText, fieldEndHintText:fieldEndHintText, fieldEndLabelText:fieldEndLabelText, fieldStartHintText:fieldStartHintText, fieldStartLabelText:fieldStartLabelText, firstDate:firstDate, helpText:helpText, initialDateRange:initialDateRange, initialEntryMode:initialEntryMode ?? DatePickerEntryMode.calendar, key:key, keyboardType:keyboardType ?? TextInputType.datetime, lastDate:lastDate, restorationId:restorationId, saveText:saveText);
},

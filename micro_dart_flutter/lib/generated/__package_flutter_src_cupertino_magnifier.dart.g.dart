...
'package:flutter/src/cupertino/magnifier.dart@CupertinoTextMagnifier@': (m.Scope scope)=>({ animationCurve,  controller,  dragResistance,  hideBelowThreshold,  horizontalScreenEdgePadding,  key,  magnifierInfo}){
return CupertinoTextMagnifier(animationCurve:animationCurve ?? Curves.easeOut, controller:controller, dragResistance:dragResistance ?? 10.0, hideBelowThreshold:hideBelowThreshold ?? 48.0, horizontalScreenEdgePadding:horizontalScreenEdgePadding ?? 10.0, key:key, magnifierInfo:magnifierInfo);
},

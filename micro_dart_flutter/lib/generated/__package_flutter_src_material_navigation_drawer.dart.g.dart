...
'package:flutter/src/material/navigation_drawer.dart@NavigationDrawerDestination@': (m.Scope scope)=>({ backgroundColor,  icon,  key,  label,  selectedIcon}){
return NavigationDrawerDestination(backgroundColor:backgroundColor, icon:icon, key:key, label:label, selectedIcon:selectedIcon);
},

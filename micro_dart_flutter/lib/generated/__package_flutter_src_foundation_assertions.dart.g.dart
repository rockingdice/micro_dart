...
'package:flutter/src/foundation/assertions.dart@PartialStackFrame@': (m.Scope scope)=>PartialStackFrame,
...
'package:flutter/src/foundation/assertions.dart@RepetitiveStackFrameFilter@': (m.Scope scope)=>RepetitiveStackFrameFilter,
...
'package:flutter/src/foundation/assertions.dart@ErrorDescription@': (m.Scope scope)=>ErrorDescription,
...
'package:flutter/src/foundation/assertions.dart@ErrorSummary@': (m.Scope scope)=>ErrorSummary,
...
'package:flutter/src/foundation/assertions.dart@ErrorHint@': (m.Scope scope)=>ErrorHint,
...
'package:flutter/src/foundation/assertions.dart@FlutterError@': (m.Scope scope)=>FlutterError,

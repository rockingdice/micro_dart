...
'package:flutter/src/widgets/texture.dart@Texture@': (m.Scope scope)=>({ filterQuality,  freeze,  key,  textureId}){
return Texture(filterQuality:filterQuality ?? FilterQuality.low, freeze:freeze ?? false, key:key, textureId:textureId);
},

...
const libraryMirror = m.LibraryMirror(
  'package:flutter/src/physics/spring_simulation.dart',
  {
    ...
    'SpringDescription.withDampingRatio': _SpringDescription_withDampingRatio_$,
    'SpringSimulation.': _SpringSimulation__$,
    'ScrollSpringSimulation.': _ScrollSpringSimulation__$,
...
Function _SpringDescription_mass$(
  m.Scope scope$,
...
Function _SpringDescription_stiffness$(
  m.Scope scope$,
  SpringDescription target$,
) =>
    () {
...
Function _SpringDescription_damping$(
  m.Scope scope$,
  SpringDescription target$,
) =>
    () {
...
Function _SpringDescription_withDampingRatio_$(m.Scope scope$) =>
...
Function _SpringSimulation_type$(
  m.Scope scope$,
...
Function _ScrollSpringSimulation__$(m.Scope scope$) => (
      SpringDescription spring,
      double start,
      double end,
      double velocity, {

...
'package:flutter/src/widgets/display_feature_sub_screen.dart@DisplayFeatureSubScreen@': (m.Scope scope)=>({ anchorPoint,  child,  key}){
return DisplayFeatureSubScreen(anchorPoint:anchorPoint, child:child, key:key);
},

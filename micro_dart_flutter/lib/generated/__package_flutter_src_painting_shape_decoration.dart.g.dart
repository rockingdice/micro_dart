...
'package:flutter/src/painting/shape_decoration.dart@ShapeDecoration@': (m.Scope scope)=>({ color,  gradient,  image,  shadows,  shape}){
return ShapeDecoration(color:color, gradient:gradient, image:image, shadows:shadows, shape:shape);
},

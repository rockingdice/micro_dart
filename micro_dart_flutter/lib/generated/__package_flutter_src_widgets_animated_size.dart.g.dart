...
'package:flutter/src/widgets/animated_size.dart@AnimatedSize@': (m.Scope scope)=>({ alignment,  child,  clipBehavior,  curve,  duration,  key,  reverseDuration}){
return AnimatedSize(alignment:alignment ?? Alignment.center, child:child, clipBehavior:clipBehavior ?? Clip.hardEdge, curve:curve ?? Curves.linear, duration:duration, key:key, reverseDuration:reverseDuration);
},

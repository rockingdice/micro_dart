...
'package:flutter/src/widgets/scroll_simulation.dart@BouncingScrollSimulation@': (m.Scope scope)=>({ constantDeceleration,  leadingExtent,  position,  spring,  tolerance,  trailingExtent,  velocity}){
return BouncingScrollSimulation(constantDeceleration:constantDeceleration ?? 0, leadingExtent:leadingExtent, position:position, spring:spring, tolerance:tolerance ?? Tolerance.defaultTolerance, trailingExtent:trailingExtent, velocity:velocity);
},
...
'package:flutter/src/widgets/scroll_simulation.dart@ClampingScrollSimulation@': (m.Scope scope)=>({ friction,  position,  tolerance,  velocity}){
return ClampingScrollSimulation(friction:friction ?? 0.015, position:position, tolerance:tolerance ?? Tolerance.defaultTolerance, velocity:velocity);
},

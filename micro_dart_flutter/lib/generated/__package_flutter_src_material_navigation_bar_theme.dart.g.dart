...
'package:flutter/src/material/navigation_bar_theme.dart@NavigationBarTheme@': (m.Scope scope)=>({ child,  data,  key}){
return NavigationBarTheme(child:child, data:data, key:key);
},

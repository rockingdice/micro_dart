...
double _MediaQueryData_devicePixelRatio$(MediaQueryData target) {
  return target.devicePixelRatio;
}

double _MediaQueryData_textScaleFactor$(MediaQueryData target) {
  return target.textScaleFactor;
}

Brightness _MediaQueryData_platformBrightness$(MediaQueryData target) {
  return target.platformBrightness;
}

EdgeInsets _MediaQueryData_viewInsets$(MediaQueryData target) {
  return target.viewInsets;
}

EdgeInsets _MediaQueryData_padding$(MediaQueryData target) {
  return target.padding;
}

EdgeInsets _MediaQueryData_viewPadding$(MediaQueryData target) {
  return target.viewPadding;
}

EdgeInsets _MediaQueryData_systemGestureInsets$(MediaQueryData target) {
  return target.systemGestureInsets;
}

bool _MediaQueryData_alwaysUse24HourFormat$(MediaQueryData target) {
  return target.alwaysUse24HourFormat;
}

bool _MediaQueryData_accessibleNavigation$(MediaQueryData target) {
  return target.accessibleNavigation;
}

bool _MediaQueryData_invertColors$(MediaQueryData target) {
  return target.invertColors;
}

bool _MediaQueryData_highContrast$(MediaQueryData target) {
  return target.highContrast;
}

bool _MediaQueryData_disableAnimations$(MediaQueryData target) {
  return target.disableAnimations;
}

bool _MediaQueryData_boldText$(MediaQueryData target) {
  return target.boldText;
}

NavigationMode _MediaQueryData_navigationMode$(MediaQueryData target) {
  return target.navigationMode;
}

DeviceGestureSettings _MediaQueryData_gestureSettings$(MediaQueryData target) {
  return target.gestureSettings;
}

List<DisplayFeature> _MediaQueryData_displayFeatures$(MediaQueryData target) {
  return target.displayFeatures;
}

Orientation _MediaQueryData_orientation$(MediaQueryData target) {
  return target.orientation;
}

int _MediaQueryData_hashCode$(MediaQueryData target) {

...
'package:flutter/src/widgets/scroll_aware_image_provider.dart@ScrollAwareImageProvider@': (m.Scope scope)=><T>({ context,  imageProvider}){
return ScrollAwareImageProvider(context:context, imageProvider:imageProvider);
},

...
const libraryMirror = m.LibraryMirror(
  ...
  {
    'ShapeDecoration.': _ShapeDecoration__$,
    'ShapeDecoration.fromBoxDecoration': _ShapeDecoration_fromBoxDecoration_$,
  ...
  {},
  {
    'ShapeDecoration': m.ClassMirror(
      'ShapeDecoration',
      {
        ...
        'createBoxPainter': _ShapeDecoration_createBoxPainter$,
      },
      {},
    )
  },
...
Function _ShapeDecoration_color$(
  m.Scope scope$,
...
Function _ShapeDecoration_gradient$(
  m.Scope scope$,
  ShapeDecoration target$,
) =>
    () {
...
Function _ShapeDecoration_image$(
  m.Scope scope$,
  ShapeDecoration target$,
) =>
    () {
...
Function _ShapeDecoration_shadows$(
  m.Scope scope$,
  ShapeDecoration target$,
) =>
    () {
...
Function _ShapeDecoration_shape$(
  m.Scope scope$,
  ShapeDecoration target$,
) =>
    () {
...
Function _ShapeDecoration_padding$(
  m.Scope scope$,
  ShapeDecoration target$,
) =>
    () {
...
Function _ShapeDecoration_isComplex$(
  m.Scope scope$,
  ShapeDecoration target$,
) =>
    () {
...
Function _ShapeDecoration_hashCode$(
  m.Scope scope$,
  ShapeDecoration target$,
) =>
    () {
...
Function _ShapeDecoration__$(m.Scope scope$) => ({
      Color? color,
...
Function _ShapeDecoration_fromBoxDecoration_$(m.Scope scope$) =>

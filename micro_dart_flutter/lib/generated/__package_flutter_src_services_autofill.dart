...
bool _AutofillConfiguration_enabled$(AutofillConfiguration target) {
  return target.enabled;
}

String _AutofillConfiguration_uniqueIdentifier$(AutofillConfiguration target) {
  return target.uniqueIdentifier;
}

List<String> _AutofillConfiguration_autofillHints$(
    AutofillConfiguration target) {
  return target.autofillHints;
}

TextEditingValue _AutofillConfiguration_currentEditingValue$(
    AutofillConfiguration target) {
  return target.currentEditingValue;
}

String? _AutofillConfiguration_hintText$(AutofillConfiguration target) {

...
'package:flutter/src/animation/tween.dart@ReverseTween@': (m.Scope scope)=><T>( parent){
...
'package:flutter/src/animation/tween.dart@ConstantTween@': (m.Scope scope)=><T>( value){
...
'package:flutter/src/animation/tween.dart@CurveTween@': (m.Scope scope)=>({ curve}){

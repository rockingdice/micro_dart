...
'package:flutter/src/widgets/scroll_position.dart@ScrollMetricsNotification@': (m.Scope scope)=>({ context,  metrics}){
return ScrollMetricsNotification(context:context, metrics:metrics);
},

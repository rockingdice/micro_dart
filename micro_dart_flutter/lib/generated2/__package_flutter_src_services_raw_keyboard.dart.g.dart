...
'package:flutter/src/services/raw_keyboard.dart@RawKeyDownEvent@': (m.Scope scope)=>({ character,  data,  repeat}){
return RawKeyDownEvent(character:character, data:data, repeat:repeat ?? false);
},
...
'package:flutter/src/services/raw_keyboard.dart@RawKeyUpEvent@': (m.Scope scope)=>({ character,  data}){
return RawKeyUpEvent(character:character, data:data);
},

...
'package:flutter/src/widgets/bottom_navigation_bar_item.dart@BottomNavigationBarItem@': (m.Scope scope)=>({ activeIcon,  backgroundColor,  icon,  label,  tooltip}){
return BottomNavigationBarItem(activeIcon:activeIcon, backgroundColor:backgroundColor, icon:icon, label:label, tooltip:tooltip);
},

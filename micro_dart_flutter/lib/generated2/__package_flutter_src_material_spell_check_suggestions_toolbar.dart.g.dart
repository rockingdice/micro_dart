...
'package:flutter/src/material/spell_check_suggestions_toolbar.dart@SpellCheckSuggestionsToolbar@': (m.Scope scope)=>({ anchor,  buttonItems,  key}){
return SpellCheckSuggestionsToolbar(anchor:anchor, buttonItems:buttonItems, key:key);
},

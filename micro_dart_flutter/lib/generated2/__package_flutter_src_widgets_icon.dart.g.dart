...
'package:flutter/src/widgets/icon.dart@Icon@': (m.Scope scope)=>( icon, { color,  fill,  grade,  key,  opticalSize,  semanticLabel,  shadows,  size,  textDirection,  weight}){
return Icon(icon, color:color, fill:fill, grade:grade, key:key, opticalSize:opticalSize, semanticLabel:semanticLabel, shadows:shadows, size:size, textDirection:textDirection, weight:weight);
},

...
'package:flutter/src/material/tooltip_visibility.dart@TooltipVisibility@': (m.Scope scope)=>({ child,  key,  visible}){
return TooltipVisibility(child:child, key:key, visible:visible);
},

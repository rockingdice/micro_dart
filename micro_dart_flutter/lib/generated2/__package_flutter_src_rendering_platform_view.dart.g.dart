...
'package:flutter/src/rendering/platform_view.dart@RenderAndroidView@': (m.Scope scope)=>({ clipBehavior,  gestureRecognizers,  hitTestBehavior,  viewController}){
return RenderAndroidView(clipBehavior:clipBehavior ?? Clip.hardEdge, gestureRecognizers:gestureRecognizers, hitTestBehavior:hitTestBehavior, viewController:viewController);
},
...
'package:flutter/src/rendering/platform_view.dart@RenderUiKitView@': (m.Scope scope)=>({ gestureRecognizers,  hitTestBehavior,  viewController}){
return RenderUiKitView(gestureRecognizers:gestureRecognizers, hitTestBehavior:hitTestBehavior, viewController:viewController);
},
...
'package:flutter/src/rendering/platform_view.dart@PlatformViewRenderBox@': (m.Scope scope)=>({ controller,  gestureRecognizers,  hitTestBehavior}){

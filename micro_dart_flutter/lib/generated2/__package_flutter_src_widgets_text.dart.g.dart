...
'package:flutter/src/widgets/text.dart@DefaultTextStyle@': (m.Scope scope)=>({ child,  key,  maxLines,  overflow,  softWrap,  style,  textAlign,  textHeightBehavior,  textWidthBasis}){
return DefaultTextStyle(child:child, key:key, maxLines:maxLines, overflow:overflow ?? TextOverflow.clip, softWrap:softWrap ?? true, style:style, textAlign:textAlign, textHeightBehavior:textHeightBehavior, textWidthBasis:textWidthBasis ?? TextWidthBasis.parent);
},
...
'package:flutter/src/widgets/text.dart@DefaultTextHeightBehavior@': (m.Scope scope)=>({ child,  key,  textHeightBehavior}){
return DefaultTextHeightBehavior(child:child, key:key, textHeightBehavior:textHeightBehavior);
},

...
'package:flutter/src/material/filled_button_theme.dart@FilledButtonTheme@': (m.Scope scope)=>({ child,  data,  key}){
return FilledButtonTheme(child:child, data:data, key:key);
},

...
'package:flutter/src/material/page.dart@MaterialPage@': (m.Scope scope)=><T>({ allowSnapshotting,  arguments,  child,  fullscreenDialog,  key,  maintainState,  name,  restorationId}){
return MaterialPage(allowSnapshotting:allowSnapshotting ?? true, arguments:arguments, child:child, fullscreenDialog:fullscreenDialog ?? false, key:key, maintainState:maintainState ?? true, name:name, restorationId:restorationId);
},

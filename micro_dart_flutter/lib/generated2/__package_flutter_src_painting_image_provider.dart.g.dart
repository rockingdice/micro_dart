...
'package:flutter/src/painting/image_provider.dart@AssetBundleImageKey@': (m.Scope scope)=>({ bundle,  name,  scale}){
...
'package:flutter/src/painting/image_provider.dart@ResizeImage@': (m.Scope scope)=>( imageProvider, { allowUpscaling,  height,  policy,  width}){
return ResizeImage(imageProvider, allowUpscaling:allowUpscaling ?? false, height:height, policy:policy ?? ResizeImagePolicy.exact, width:width);
},
...
'package:flutter/src/painting/image_provider.dart@NetworkImage@': (m.Scope scope)=>( url, { headers,  scale}){
...
'package:flutter/src/painting/image_provider.dart@FileImage@': (m.Scope scope)=>( file, { scale}){
...
'package:flutter/src/painting/image_provider.dart@MemoryImage@': (m.Scope scope)=>( bytes, { scale}){
return MemoryImage(bytes, scale:scale ?? 1.0);
},
...
'package:flutter/src/painting/image_provider.dart@ExactAssetImage@': (m.Scope scope)=>( assetName, { bundle,  package,  scale}){
return ExactAssetImage(assetName, bundle:bundle, package:package, scale:scale ?? 1.0);
},
...
'package:flutter/src/painting/image_provider.dart@NetworkImageLoadException@': (m.Scope scope)=>({ statusCode,  uri}){

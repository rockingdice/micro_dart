...
'package:flutter/src/widgets/restoration.dart@RestorationScope@': (m.Scope scope)=>({ child,  key,  restorationId}){
return RestorationScope(child:child, key:key, restorationId:restorationId);
},
...
'package:flutter/src/widgets/restoration.dart@UnmanagedRestorationScope@': (m.Scope scope)=>({ bucket,  child,  key}){
return UnmanagedRestorationScope(bucket:bucket, child:child, key:key);
},
...
'package:flutter/src/widgets/restoration.dart@RootRestorationScope@': (m.Scope scope)=>({ child,  key,  restorationId}){
return RootRestorationScope(child:child, key:key, restorationId:restorationId);
},

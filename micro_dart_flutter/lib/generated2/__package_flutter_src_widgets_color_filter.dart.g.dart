...
'package:flutter/src/widgets/color_filter.dart@ColorFiltered@': (m.Scope scope)=>({ child,  colorFilter,  key}){
return ColorFiltered(child:child, colorFilter:colorFilter, key:key);
},

...
'package:flutter/src/cupertino/adaptive_text_selection_toolbar.dart@CupertinoAdaptiveTextSelectionToolbar@': (m.Scope scope)=>({ anchors,  children,  key}){
return CupertinoAdaptiveTextSelectionToolbar(anchors:anchors, children:children, key:key);
},

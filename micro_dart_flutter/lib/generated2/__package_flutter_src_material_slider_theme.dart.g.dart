...
'package:flutter/src/material/slider_theme.dart@SliderTheme@': (m.Scope scope)=>({ child,  data,  key}){
return SliderTheme(child:child, data:data, key:key);
},
...
'package:flutter/src/material/slider_theme.dart@RangeValues@': (m.Scope scope)=>( start,  end){
...
'package:flutter/src/material/slider_theme.dart@RangeLabels@': (m.Scope scope)=>( start,  end){

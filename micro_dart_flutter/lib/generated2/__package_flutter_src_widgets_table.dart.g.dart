...
'package:flutter/src/widgets/table.dart@TableCell@': (m.Scope scope)=>({ child,  key,  verticalAlignment}){
return TableCell(child:child, key:key, verticalAlignment:verticalAlignment);
},

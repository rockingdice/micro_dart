...
'package:flutter/src/services/text_boundary.dart@CharacterBoundary@': (m.Scope scope)=>( _text){
...
'package:flutter/src/services/text_boundary.dart@LineBoundary@': (m.Scope scope)=>( _textLayout){
...
'package:flutter/src/services/text_boundary.dart@ParagraphBoundary@': (m.Scope scope)=>( _text){
...
'package:flutter/src/services/text_boundary.dart@DocumentBoundary@': (m.Scope scope)=>( _text){

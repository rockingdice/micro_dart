...
'package:flutter/src/material/animated_icons.dart@AnimatedIcon@': (m.Scope scope)=>({ color,  icon,  key,  progress,  semanticLabel,  size,  textDirection}){
return AnimatedIcon(color:color, icon:icon, key:key, progress:progress, semanticLabel:semanticLabel, size:size, textDirection:textDirection);
},

...
'package:flutter/src/services/text_editing.dart@TextSelection@': (m.Scope scope)=>({ affinity,  baseOffset,  extentOffset,  isDirectional}){
return TextSelection(affinity:affinity ?? TextAffinity.downstream, baseOffset:baseOffset, extentOffset:extentOffset, isDirectional:isDirectional ?? false);
},

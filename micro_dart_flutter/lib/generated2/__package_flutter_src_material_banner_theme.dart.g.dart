...
'package:flutter/src/material/banner_theme.dart@MaterialBannerTheme@': (m.Scope scope)=>({ child,  data,  key}){
return MaterialBannerTheme(child:child, data:data, key:key);
},

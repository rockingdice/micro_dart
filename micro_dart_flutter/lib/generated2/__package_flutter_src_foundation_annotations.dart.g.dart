...
'package:flutter/src/foundation/annotations.dart@Category@': (m.Scope scope)=>( sections){
...
'package:flutter/src/foundation/annotations.dart@DocumentationIcon@': (m.Scope scope)=>( url){
...
'package:flutter/src/foundation/annotations.dart@Summary@': (m.Scope scope)=>( text){
return Summary(text);
},

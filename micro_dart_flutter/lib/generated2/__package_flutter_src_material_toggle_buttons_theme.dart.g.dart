...
'package:flutter/src/material/toggle_buttons_theme.dart@ToggleButtonsTheme@': (m.Scope scope)=>({ child,  data,  key}){
return ToggleButtonsTheme(child:child, data:data, key:key);
},

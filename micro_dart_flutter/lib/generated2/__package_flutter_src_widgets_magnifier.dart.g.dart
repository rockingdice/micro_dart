...
'package:flutter/src/widgets/magnifier.dart@MagnifierInfo@': (m.Scope scope)=>({ caretRect,  currentLineBoundaries,  fieldBounds,  globalGesturePosition}){
return MagnifierInfo(caretRect:caretRect, currentLineBoundaries:currentLineBoundaries, fieldBounds:fieldBounds, globalGesturePosition:globalGesturePosition);
},
...
'package:flutter/src/widgets/magnifier.dart@RawMagnifier@': (m.Scope scope)=>({ child,  decoration,  focalPointOffset,  key,  magnificationScale,  size}){
return RawMagnifier(child:child, decoration:decoration ?? const MagnifierDecoration(), focalPointOffset:focalPointOffset ?? Offset.zero, key:key, magnificationScale:magnificationScale ?? 1, size:size);
},

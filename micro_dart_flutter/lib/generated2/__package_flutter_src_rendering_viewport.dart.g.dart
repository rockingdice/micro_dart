...
'package:flutter/src/rendering/viewport.dart@RevealedOffset@': (m.Scope scope)=>({ offset,  rect}){
...
'package:flutter/src/rendering/viewport.dart@RenderViewport@': (m.Scope scope)=>({ anchor,  axisDirection,  cacheExtent,  cacheExtentStyle,  center,  children,  clipBehavior,  crossAxisDirection,  offset}){
return RenderViewport(anchor:anchor ?? 0.0, axisDirection:axisDirection ?? AxisDirection.down, cacheExtent:cacheExtent, cacheExtentStyle:cacheExtentStyle ?? CacheExtentStyle.pixel, center:center, children:children, clipBehavior:clipBehavior ?? Clip.hardEdge, crossAxisDirection:crossAxisDirection, offset:offset);
},
...
'package:flutter/src/rendering/viewport.dart@RenderShrinkWrappingViewport@': (m.Scope scope)=>({ axisDirection,  children,  clipBehavior,  crossAxisDirection,  offset}){
return RenderShrinkWrappingViewport(axisDirection:axisDirection ?? AxisDirection.down, children:children, clipBehavior:clipBehavior ?? Clip.hardEdge, crossAxisDirection:crossAxisDirection, offset:offset);
},

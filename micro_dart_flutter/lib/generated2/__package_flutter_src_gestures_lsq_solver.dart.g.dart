...
'package:flutter/src/gestures/lsq_solver.dart@PolynomialFit@': (m.Scope scope)=>( degree){
...
'package:flutter/src/gestures/lsq_solver.dart@LeastSquaresSolver@': (m.Scope scope)=>( x,  y,  w){

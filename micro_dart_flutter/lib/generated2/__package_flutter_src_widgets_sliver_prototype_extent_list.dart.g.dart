...
'package:flutter/src/widgets/sliver_prototype_extent_list.dart@SliverPrototypeExtentList@': (m.Scope scope)=>({ delegate,  key,  prototypeItem}){
return SliverPrototypeExtentList(delegate:delegate, key:key, prototypeItem:prototypeItem);
},

...
'package:flutter/src/widgets/list_wheel_scroll_view.dart@ListWheelChildListDelegate@': (m.Scope scope)=>({ children}){
...
'package:flutter/src/widgets/list_wheel_scroll_view.dart@ListWheelChildLoopingListDelegate@': (m.Scope scope)=>({ children}){
...
'package:flutter/src/widgets/list_wheel_scroll_view.dart@FixedExtentMetrics@': (m.Scope scope)=>({ axisDirection,  devicePixelRatio,  itemIndex,  maxScrollExtent,  minScrollExtent,  pixels,  viewportDimension}){
return FixedExtentMetrics(axisDirection:axisDirection, devicePixelRatio:devicePixelRatio, itemIndex:itemIndex, maxScrollExtent:maxScrollExtent, minScrollExtent:minScrollExtent, pixels:pixels, viewportDimension:viewportDimension);
},
...
'package:flutter/src/widgets/list_wheel_scroll_view.dart@ListWheelElement@': (m.Scope scope)=>( widget){
...
'package:flutter/src/widgets/list_wheel_scroll_view.dart@ListWheelViewport@': (m.Scope scope)=>({ childDelegate,  clipBehavior,  diameterRatio,  itemExtent,  key,  magnification,  offAxisFraction,  offset,  overAndUnderCenterOpacity,  perspective,  renderChildrenOutsideViewport,  squeeze,  useMagnifier}){
return ListWheelViewport(childDelegate:childDelegate, clipBehavior:clipBehavior ?? Clip.hardEdge, diameterRatio:diameterRatio ?? RenderListWheelViewport.defaultDiameterRatio, itemExtent:itemExtent, key:key, magnification:magnification ?? 1.0, offAxisFraction:offAxisFraction ?? 0.0, offset:offset, overAndUnderCenterOpacity:overAndUnderCenterOpacity ?? 1.0, perspective:perspective ?? RenderListWheelViewport.defaultPerspective, renderChildrenOutsideViewport:renderChildrenOutsideViewport ?? false, squeeze:squeeze ?? 1.0, useMagnifier:useMagnifier ?? false);
},

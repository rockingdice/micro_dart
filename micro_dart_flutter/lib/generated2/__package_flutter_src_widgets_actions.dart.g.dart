...
'package:flutter/src/widgets/actions.dart@Actions@': (m.Scope scope)=>({ actions,  child,  dispatcher,  key}){
return Actions(actions:actions, child:child, dispatcher:dispatcher, key:key);
},
...
'package:flutter/src/widgets/actions.dart@PrioritizedIntents@': (m.Scope scope)=>({ orderedIntents}){
return PrioritizedIntents(orderedIntents:orderedIntents);
},

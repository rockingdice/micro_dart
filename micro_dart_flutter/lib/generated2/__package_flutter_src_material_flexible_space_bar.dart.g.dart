...
'package:flutter/src/material/flexible_space_bar.dart@FlexibleSpaceBarSettings@': (m.Scope scope)=>({ child,  currentExtent,  isScrolledUnder,  key,  maxExtent,  minExtent,  toolbarOpacity}){
return FlexibleSpaceBarSettings(child:child, currentExtent:currentExtent, isScrolledUnder:isScrolledUnder, key:key, maxExtent:maxExtent, minExtent:minExtent, toolbarOpacity:toolbarOpacity);
},

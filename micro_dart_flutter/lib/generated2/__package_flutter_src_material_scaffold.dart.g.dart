...
'package:flutter/src/material/scaffold.dart@ScaffoldMessenger@': (m.Scope scope)=>({ child,  key}){
return ScaffoldMessenger(child:child, key:key);
},
...
'package:flutter/src/material/scaffold.dart@ScaffoldPrelayoutGeometry@': (m.Scope scope)=>({ bottomSheetSize,  contentBottom,  contentTop,  floatingActionButtonSize,  materialBannerSize,  minInsets,  minViewPadding,  scaffoldSize,  snackBarSize,  textDirection}){
return ScaffoldPrelayoutGeometry(bottomSheetSize:bottomSheetSize, contentBottom:contentBottom, contentTop:contentTop, floatingActionButtonSize:floatingActionButtonSize, materialBannerSize:materialBannerSize, minInsets:minInsets, minViewPadding:minViewPadding, scaffoldSize:scaffoldSize, snackBarSize:snackBarSize, textDirection:textDirection);
},

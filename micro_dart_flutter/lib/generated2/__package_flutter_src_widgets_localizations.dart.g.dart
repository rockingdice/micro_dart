...
'package:flutter/src/widgets/localizations.dart@Localizations@': (m.Scope scope)=>({ child,  delegates,  key,  locale}){
return Localizations(child:child, delegates:delegates, key:key, locale:locale);
},

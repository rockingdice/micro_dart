...
'package:flutter/src/rendering/proxy_sliver.dart@RenderSliverAnimatedOpacity@': (m.Scope scope)=>({ alwaysIncludeSemantics,  opacity,  sliver}){
return RenderSliverAnimatedOpacity(alwaysIncludeSemantics:alwaysIncludeSemantics ?? false, opacity:opacity, sliver:sliver);
},

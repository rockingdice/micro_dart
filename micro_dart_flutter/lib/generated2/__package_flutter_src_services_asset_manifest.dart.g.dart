...
'package:flutter/src/services/asset_manifest.dart@AssetMetadata@': (m.Scope scope)=>({ key,  main,  targetDevicePixelRatio}){
return AssetMetadata(key:key, main:main, targetDevicePixelRatio:targetDevicePixelRatio);
},

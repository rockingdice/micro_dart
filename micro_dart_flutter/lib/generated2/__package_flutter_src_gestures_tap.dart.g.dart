...
'package:flutter/src/gestures/tap.dart@TapUpDetails@': (m.Scope scope)=>({ globalPosition,  kind,  localPosition}){
return TapUpDetails(globalPosition:globalPosition ?? Offset.zero, kind:kind, localPosition:localPosition);
},

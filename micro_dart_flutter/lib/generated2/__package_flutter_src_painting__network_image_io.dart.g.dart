...
'package:flutter/src/painting/_network_image_io.dart@NetworkImage@': (m.Scope scope)=>( url, { headers,  scale}){
return NetworkImage(url, headers:headers, scale:scale ?? 1.0);
},

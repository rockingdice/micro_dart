...
'package:flutter/src/widgets/safe_area.dart@SafeArea@': (m.Scope scope)=>({ bottom,  child,  key,  left,  maintainBottomViewPadding,  minimum,  right,  top}){
return SafeArea(bottom:bottom ?? true, child:child, key:key, left:left ?? true, maintainBottomViewPadding:maintainBottomViewPadding ?? false, minimum:minimum ?? EdgeInsets.zero, right:right ?? true, top:top ?? true);
},
...
'package:flutter/src/widgets/safe_area.dart@SliverSafeArea@': (m.Scope scope)=>({ bottom,  key,  left,  minimum,  right,  sliver,  top}){
return SliverSafeArea(bottom:bottom ?? true, key:key, left:left ?? true, minimum:minimum ?? EdgeInsets.zero, right:right ?? true, sliver:sliver, top:top ?? true);
},

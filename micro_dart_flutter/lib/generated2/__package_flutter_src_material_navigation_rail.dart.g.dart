...
'package:flutter/src/material/navigation_rail.dart@NavigationRailDestination@': (m.Scope scope)=>({ icon,  indicatorColor,  indicatorShape,  label,  padding,  selectedIcon}){
return NavigationRailDestination(icon:icon, indicatorColor:indicatorColor, indicatorShape:indicatorShape, label:label, padding:padding, selectedIcon:selectedIcon);
},

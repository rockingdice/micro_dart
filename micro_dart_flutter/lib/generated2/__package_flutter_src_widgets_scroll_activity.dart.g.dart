...
'package:flutter/src/widgets/scroll_activity.dart@IdleScrollActivity@': (m.Scope scope)=>( delegate){
...
'package:flutter/src/widgets/scroll_activity.dart@DragScrollActivity@': (m.Scope scope)=>( delegate,  controller){
...
'package:flutter/src/widgets/scroll_activity.dart@BallisticScrollActivity@': (m.Scope scope)=>( delegate,  simulation,  vsync,  shouldIgnorePointer){
return BallisticScrollActivity(delegate, simulation, vsync, shouldIgnorePointer);
},
...
'package:flutter/src/widgets/scroll_activity.dart@DrivenScrollActivity@': (m.Scope scope)=>( delegate, { curve,  duration,  from,  to,  vsync}){
return DrivenScrollActivity(delegate, curve:curve, duration:duration, from:from, to:to, vsync:vsync);
},

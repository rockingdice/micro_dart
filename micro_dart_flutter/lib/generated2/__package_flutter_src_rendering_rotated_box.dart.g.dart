...
'package:flutter/src/rendering/rotated_box.dart@RenderRotatedBox@': (m.Scope scope)=>({ child,  quarterTurns}){
return RenderRotatedBox(child:child, quarterTurns:quarterTurns);
},

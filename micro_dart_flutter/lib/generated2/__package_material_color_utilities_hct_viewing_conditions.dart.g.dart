...
'package:material_color_utilities/hct/viewing_conditions.dart@ViewingConditions@': (m.Scope scope)=>({ adaptingLuminance,  aw,  backgroundLstar,  backgroundYTowhitePointY,  c,  discountingIlluminant,  drgbInverse,  fLRoot,  fl,  nC,  nbb,  ncb,  rgbD,  surround,  whitePoint,  z}){
return ViewingConditions(adaptingLuminance:adaptingLuminance, aw:aw, backgroundLstar:backgroundLstar, backgroundYTowhitePointY:backgroundYTowhitePointY, c:c, discountingIlluminant:discountingIlluminant, drgbInverse:drgbInverse, fLRoot:fLRoot, fl:fl, nC:nC, nbb:nbb, ncb:ncb, rgbD:rgbD, surround:surround, whitePoint:whitePoint, z:z);
},

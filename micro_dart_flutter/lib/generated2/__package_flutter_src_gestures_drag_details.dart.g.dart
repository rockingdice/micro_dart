...
'package:flutter/src/gestures/drag_details.dart@DragUpdateDetails@': (m.Scope scope)=>({ delta,  globalPosition,  localPosition,  primaryDelta,  sourceTimeStamp}){
return DragUpdateDetails(delta:delta ?? Offset.zero, globalPosition:globalPosition, localPosition:localPosition, primaryDelta:primaryDelta, sourceTimeStamp:sourceTimeStamp);
},

...
'package:flutter/src/foundation/memory_allocations.dart@ObjectCreated@': (m.Scope scope)=>({ className,  library,  object}){
return ObjectCreated(className:className, library:library, object:object);
},
...
'package:flutter/src/foundation/memory_allocations.dart@ObjectDisposed@': (m.Scope scope)=>({ object}){

...
'package:collection/src/unmodifiable_wrappers.dart@NonGrowableListView@': (m.Scope scope)=><E>( listBase){
return NonGrowableListView(listBase);
},
...
'package:collection/src/unmodifiable_wrappers.dart@UnmodifiableSetView@': (m.Scope scope)=><E>( setBase){
return UnmodifiableSetView(setBase);
},

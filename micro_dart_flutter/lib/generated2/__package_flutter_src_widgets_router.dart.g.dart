...
'package:flutter/src/widgets/router.dart@RouterConfig@': (m.Scope scope)=><T>({ backButtonDispatcher,  routeInformationParser,  routeInformationProvider,  routerDelegate}){
return RouterConfig(backButtonDispatcher:backButtonDispatcher, routeInformationParser:routeInformationParser, routeInformationProvider:routeInformationProvider, routerDelegate:routerDelegate);
},
...
'package:flutter/src/widgets/router.dart@Router@': (m.Scope scope)=><T>({ backButtonDispatcher,  key,  restorationScopeId,  routeInformationParser,  routeInformationProvider,  routerDelegate}){
return Router(backButtonDispatcher:backButtonDispatcher, key:key, restorationScopeId:restorationScopeId, routeInformationParser:routeInformationParser, routeInformationProvider:routeInformationProvider, routerDelegate:routerDelegate);
},
...
'package:flutter/src/widgets/router.dart@ChildBackButtonDispatcher@': (m.Scope scope)=>( parent){
...
'package:flutter/src/widgets/router.dart@PlatformRouteInformationProvider@': (m.Scope scope)=>({ initialRouteInformation}){
return PlatformRouteInformationProvider(initialRouteInformation:initialRouteInformation);
},

...
'package:flutter/src/rendering/texture.dart@TextureBox@': (m.Scope scope)=>({ filterQuality,  freeze,  textureId}){
return TextureBox(filterQuality:filterQuality ?? FilterQuality.low, freeze:freeze ?? false, textureId:textureId);
},

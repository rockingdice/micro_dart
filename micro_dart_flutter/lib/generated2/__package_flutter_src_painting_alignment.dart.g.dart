...
'package:flutter/src/painting/alignment.dart@Alignment@': (m.Scope scope)=>( x,  y){
...
'package:flutter/src/painting/alignment.dart@AlignmentDirectional@': (m.Scope scope)=>( start,  y){
...
'package:flutter/src/painting/alignment.dart@TextAlignVertical@': (m.Scope scope)=>({ y}){

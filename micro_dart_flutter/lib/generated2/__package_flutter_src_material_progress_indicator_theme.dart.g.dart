...
'package:flutter/src/material/progress_indicator_theme.dart@ProgressIndicatorTheme@': (m.Scope scope)=>({ child,  data,  key}){
return ProgressIndicatorTheme(child:child, data:data, key:key);
},

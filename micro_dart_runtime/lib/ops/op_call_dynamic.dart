...
class CallDynamic implements Op {
  ...
  void run(MicroRuntime runtime) {
    var instance = runtime.scope.getFrame(
        ...
        as Instance;
    var key =
        runtime.engine.getKeyByType(instance.type, _name, isSetter: _isSetter);
    print("$key ${instance.type} $_name");
  ...
  @override
  String toString() =>
      'CallDynamic($_name,$_isGetter,$_isSetter,$_posationalLength,$_namedList)';
}

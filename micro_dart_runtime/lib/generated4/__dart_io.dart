...
Function _IOOverrides_runZoned$(m.Scope scope$) => (
      ...
      Directory createDirectoryProxy(String $p0) =>
      ...
      File createFileProxy(String $p0) => scope$.engine.callFunctionPointer(
            scope$,
            createFile!,
            [$p0],
            {},
          );
      Link createLinkProxy(String $p0) => scope$.engine.callFunctionPointer(
            scope$,
            createLink!,
            [$p0],
            {},
      ...
      void setCurrentDirectoryProxy(String $p0) =>
          scope$.engine.callFunctionPointer(
            scope$,
            setCurrentDirectory!,
            [$p0],
      ...
      Future<FileStat> statProxy(String $p0) async =>
          await scope$.engine.callFunctionPointerAsync(
            scope$,
            stat!,
            [$p0],
      ...
      FileStat statSyncProxy(String $p0) => scope$.engine.callFunctionPointer(
            scope$,
            statSync!,
            [$p0],
            {},
...
Function _SecureServerSocket_listen$(
  ...
  SecureServerSocket target$,
    ...
    (
      ...
      void onDataProxy(SecureSocket socket) =>
          scope$.engine.callFunctionPointer(
            scope$,
            onData!,
            [socket],
...
Function _RawSecureServerSocket_listen$(
  ...
  RawSecureServerSocket target$,
    ...
    (
      ...
      void onDataProxy(RawSecureSocket s) => scope$.engine.callFunctionPointer(
            scope$,
            onData!,
            [s],
            {},
...
Function _SecureSocket_connect$(m.Scope scope$) => (
      ...
      void keyLogProxy(String line) => scope$.engine.callFunctionPointer(
            scope$,
            keyLog!,
            [line],
            {},
          );
      bool onBadCertificateProxy(X509Certificate certificate) =>
          scope$.engine.callFunctionPointer(
            scope$,
            onBadCertificate!,
            [certificate],

...
Function _HashMap__$(m.Scope scope$) => ({
      ...
      int hashCodeProxy(dynamic $p0) => scope$.engine.callFunctionPointer(
            scope$,
            hashCode!,
            [$p0],
            {},
          );
      bool isValidKeyProxy(dynamic $p0) => scope$.engine.callFunctionPointer(
            scope$,
            isValidKey!,
            [$p0],
            {},
...
Function _LinkedList_forEach$(
  ...
  LinkedList target$,
    ...
    <E extends LinkedListEntry<E>>(m.FunctionPointer action) {
      void actionProxy(dynamic entry) => scope$.engine.callFunctionPointer(
            scope$,
            action,
            [entry],
            {},
...
Function _ListBase_map$(
  ...
  ListBase target$,
    ...
    (m.FunctionPointer f) {
      dynamic fProxy(dynamic element) => scope$.engine.callFunctionPointer(
            scope$,
            f,
            [element],
            {},
...
Function _ListBase_expand$(
  ...
  ListBase target$,
    ...
    (m.FunctionPointer f) {
      Iterable fProxy(dynamic element) => scope$.engine.callFunctionPointer(
            scope$,
            f,
            [element],
            {},
...
Function _DoubleLinkedQueue_forEachEntry$(
  ...
  DoubleLinkedQueue target$,
    ...
    (m.FunctionPointer action) {
      void actionProxy(DoubleLinkedQueueEntry element) =>
          scope$.engine.callFunctionPointer(
            scope$,
            action,
            [element],
...
Function _ListQueue_forEach$(
  ...
  ListQueue target$,
    ...
    (m.FunctionPointer f) {
      void fProxy(dynamic element) => scope$.engine.callFunctionPointer(
            scope$,
            f,
            [element],
            {},
...
Function _SetBase_where$(
  ...
  SetBase target$,
    ...
    (m.FunctionPointer f) {
      bool fProxy(dynamic element) => scope$.engine.callFunctionPointer(
            scope$,
            f,
            [element],
            {},
...
Function _SplayTreeMap__$(m.Scope scope$) => ([
      ...
      bool isValidKeyProxy(dynamic potentialKey) =>
          scope$.engine.callFunctionPointer(
            scope$,
            isValidKey!,
            [potentialKey],

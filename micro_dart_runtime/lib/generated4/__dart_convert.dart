...
Function _ByteConversionSink_withCallback_$(m.Scope scope$) =>
    (m.FunctionPointer callback) {
      void callbackProxy(List accumulated) => scope$.engine.callFunctionPointer(
            scope$,
            callback,
            [accumulated],
            {},
...
Function _JsonCodec__$(m.Scope scope$) => ({
      ...
      Object? toEncodableProxy(dynamic object) =>
          scope$.engine.callFunctionPointer(
            scope$,
            toEncodable!,
            [object],
...
Function _JsonUtf8Encoder__$(m.Scope scope$) => ([
      ...
      dynamic toEncodableProxy(dynamic object) =>
          scope$.engine.callFunctionPointer(
            scope$,
            toEncodable!,
            [object],
...
Function _StringConversionSink_withCallback_$(m.Scope scope$) =>
    (m.FunctionPointer callback) {
      void callbackProxy(String accumulated) =>
          scope$.engine.callFunctionPointer(
            scope$,
            callback,
            [accumulated],

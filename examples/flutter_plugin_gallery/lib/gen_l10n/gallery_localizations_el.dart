...
class GalleryLocalizationsEl extends GalleryLocalizations {
  ...
  @override
  String get demoCupertinoPickerDescription => 'Ένα γραφικό στοιχείο εργαλείου επιλογής τύπου iOS το οποίο μπορεί να χρησιμοποιηθεί για την επιλογή συμβολοσειρών, ημερομηνιών, ωρών ή της ημερομηνίας και της ώρας μαζί.';
  ...
  @override
  String get demoCupertinoSearchTextFieldSubtitle => 'Πεδίο κειμένου αναζήτησης τύπου iOS';

  @override
  String get demoCupertinoSearchTextFieldDescription => 'Ένα πεδίο κειμένου αναζήτησης που επιτρέπει στον χρήστη να κάνει αναζητήσεις καταχωρίζοντας κείμενο και το οποίο μπορεί να προσφέρει και να φιλτράρει προτάσεις.';
  ...
  @override
  String get demoCupertinoScrollbarDescription => 'Μια γραμμή κύλισης που αναδιπλώνει το θυγατρικό στοιχείο';

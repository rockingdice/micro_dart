...
class GalleryLocalizationsRu extends GalleryLocalizations {
  ...
  @override
  String get demoCupertinoPickerDescription => 'Окно выбора в стиле iOS, которое можно использовать, чтобы указать строку, дату или время.';
  ...
  @override
  String get demoCupertinoSearchTextFieldDescription => 'Поле поиска, где пользователь может вводить текстовые запросы, а также просматривать и фильтровать подсказки.';
  ...
  @override
  String get demoCupertinoScrollbarDescription => 'Полоса прокрутки для просмотра дочернего элемента.';

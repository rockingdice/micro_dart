...
class GalleryLocalizationsZhHk extends GalleryLocalizationsZh {
  ...
  @override
  String get demoCupertinoSearchTextFieldDescription => '搜尋文字欄位可讓使用者透過輸入文字來搜尋，並可提供和篩選建議。';
...
class GalleryLocalizationsZhTw extends GalleryLocalizationsZh {
  ...
  @override
  String get demoCardDescription => '卡片是一種 Material Design 資訊表，用來表示某些相關的資訊，例如相簿、地理位置、餐點、聯絡人詳細資料等等。';
  ...
  @override
  String get demoNavigationDrawerDescription => '一種 Material Design 面板，只要從畫面邊緣水平向內滑動，即可顯示應用程式中的導覽連結。';
  ...
  @override
  String get demoCupertinoPickerDescription => '一種 iOS 樣式的挑選器小工具，可用來選取字串、日期、時間，或者同時選取日期和時間。';
  ...
  @override
  String get demoCupertinoSearchTextFieldDescription => '一種搜尋文字欄位，除了可讓使用者輸入文字進行搜尋，還可以提供及篩選建議。';
  ...
  @override
  String get demoCircularProgressIndicatorDescription => 'Material Design 的圓形進度指標，會以旋轉方式表示應用程式目前忙碌中。';

  @override
  String get demoLinearProgressIndicatorTitle => '直線進度指標';

  @override
  String get demoLinearProgressIndicatorDescription => 'Material Design 的直線進度指標，又稱為進度列。';
  ...
  @override
  String get demoDateRangePickerDescription => '顯示內含 Material Design 日期範圍挑選器的對話方塊。';
  ...
  @override
  String get demoSelectionControlsSwitchDescription => '「開啟/關閉」切換鈕是用來切換單一設定選項的狀態。切換鈕控制的選項及其目前狀態都應在對應的內嵌標籤上清楚顯示。';

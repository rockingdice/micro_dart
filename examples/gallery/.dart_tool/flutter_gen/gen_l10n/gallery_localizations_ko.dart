...
class GalleryLocalizationsKo extends GalleryLocalizations {
  ...
  @override
  String get demoCupertinoPickerDescription => '날짜와 시간을 동시에 선택하거나 날짜, 시간, 문자열을 각각 선택하는 데 사용할 수 있는 iOS 스타일의 선택 도구 위젯입니다.';
  ...
  @override
  String get demoCupertinoSearchTextFieldDescription => '사용자가 텍스트를 입력하여 검색할 수 있고 추천 검색어를 제시하고 필터링할 수 있는 검색 텍스트 입력란입니다.';

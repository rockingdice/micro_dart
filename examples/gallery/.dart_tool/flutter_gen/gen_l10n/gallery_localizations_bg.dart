...
class GalleryLocalizationsBg extends GalleryLocalizations {
  ...
  @override
  String get demoCupertinoPickerDescription => 'Приспособление за избор на низове, дати, часове или дати и часове в стил iOS.';
  ...
  @override
  String get demoCupertinoSearchTextFieldSubtitle => 'Текстово поле за търсене в стил iOS';

  @override
  String get demoCupertinoSearchTextFieldDescription => 'Текстово поле за търсене, което дава възможност на потребителя да търси, като въвежда текст, и може да предлага и филтрира предложения.';
  ...
  @override
  String get demoCupertinoScrollbarDescription => 'Лента за превъртане, която обхваща дадения дъщерен елемент';

...
class GalleryLocalizationsFa extends GalleryLocalizations {
  ...
  @override
  String get demoCupertinoPickerDescription => 'ابزارک انتخاب‌گر سبک iOS که می‌توان برای انتخاب رشته، تاریخ، زمان، یا هم زمان و هم تاریخ استفاده کرد.';
  ...
  @override
  String get demoCupertinoSearchTextFieldSubtitle => 'فیلد نوشتاری جستجو به‌سبک iOS';

  @override
  String get demoCupertinoSearchTextFieldDescription => 'فیلد نوشتاری جستجویی که به کاربر اجازه می‌دهد با وارد کردن نوشتار جستجو کند و می‌تواند پیشنهادهایی ارائه دهد و آن‌ها را فیلتر کند';
  ...
  @override
  String get demoCupertinoScrollbarDescription => 'نوار پیمایشی که کودکان را درنظر می‌گیرد';

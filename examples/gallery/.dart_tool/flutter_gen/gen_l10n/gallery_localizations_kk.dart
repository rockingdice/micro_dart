...
class GalleryLocalizationsKk extends GalleryLocalizations {
  ...
  @override
  String get fortnightlyDescription => 'Контентке бағытталған жаңалықтар қолданбасы';
  ...
  @override
  String get demoAppBarDescription => 'Қолданба жолағында ағымдағы экранға қатысы бар контент мен әрекеттер көрсетіледі. Бұл жолақ брендинг, экран атаулары, навигация және әрекеттер үшін пайдаланылады.';
  ...
  @override
  String get demoElevatedButtonDescription => 'Көтеріңкі түймелер тегіс форматтағы контентдарға көлем береді. Олар контент тығыз не сирек орналасқан кезде функцияларды ерекшелеу үшін қолданылады.';
  ...
  @override
  String get demoFloatingButtonDescription => 'Қалқымалы әрекет түймесі – қолданбадағы негізгі әрекетті жарнамалау үшін контент үстінде тұратын белгішесі бар домалақ түйме.';
  ...
  @override
  String get demoActionChipDescription => 'Әрекет чиптері — негізгі контентке қатысты әрекетті іске қосатын параметрлер жиынтығы. Олар пайдаланушы интерфейсінде динамикалық және контекстік күйде көрсетілуі керек.';
  ...
  @override
  String get demoFilterChipDescription => 'Cүзгі чиптері контентті сүзу үшін тэгтер немесе сипаттаушы сөздер пайдаланады.';
  ...
  @override
  String get demoDividerSubtitle => 'Бөлгіш – контентті тізімдер мен схемаларға топтастыратын жіңішке сызық.';

  @override
  String get demoDividerDescription => 'Бөлгіштерді тізімдерде, тартпаларда және басқа орындарда контентті бөлу үшін пайдалануға болады.';
  ...
  @override
  String get demoCupertinoAlertDescription => 'Ескертудің диалогтік терезесі пайдаланушыға назар аударуды қажет ететін жағдайларды хабарлайды. Бұл терезенің қосымша атауы, контенті және әрекеттер тізімі болады. Атауы контенттің үстінде, ал әрекеттер контенттің астында көрсетіледі.';
  ...
  @override
  String get demoCupertinoActionSheetDescription => 'Әрекеттер парағы – пайдаланушыға ағымдағы контентке қатысты екі не одан да көп таңдаулар жинағын ұсынатын ескертулердің арнайы стилі. Әрекеттер парағында оның атауы, қосымша хабары және әрекеттер тізімі қамтылуы мүмкін.';
  ...
  @override
  String get demoCupertinoPickerDescription => 'Жолдарды, күндерді, уақытты немесе күн мен уақытты бірге таңдауға қолданылатын iOS стиліндегі таңдағыш.';
  ...
  @override
  String get demoCupertinoSearchTextFieldSubtitle => 'iOS стиліндегі мәтін іздеу өрісі';

  @override
  String get demoCupertinoSearchTextFieldDescription => 'Пайдаланушыға мәтін енгізуге, сондай-ақ ұсыныстарды көрсетіп, сүзуге мүмкіндік беретін мәтін іздеу өрісі.';
  ...
  @override
  String get demoCupertinoScrollbarSubtitle => 'iOS стиліндегі айналдыру жолағы';

  @override
  String get demoCupertinoScrollbarDescription => 'Басты бетте көрінетін айналдыру жолағы';
  ...
  @override
  String get demoTabsDescription => 'Қойындылар түрлі экрандардағы, деректер жинағындағы және тағы басқа өзара қатынастардағы контентті реттейді.';
  ...
  @override
  String get craneFly5SemanticLabel => 'Таулар алдындағы көл жағасындағы қонақ үй';
  ...
  @override
  String get craneSleep4SemanticLabel => 'Таулар алдындағы көл жағасындағы қонақ үй';

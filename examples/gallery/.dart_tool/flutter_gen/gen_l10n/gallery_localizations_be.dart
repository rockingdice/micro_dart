...
class GalleryLocalizationsBe extends GalleryLocalizations {
  ...
  @override
  String get demoCupertinoPickerDescription => 'Віджэт інструмента выбару ў стылі iOS, які можа выкарыстоўвацца для выбару радкоў, дат, часу ці адначасова даты і часу.';
  ...
  @override
  String get demoCupertinoSearchTextFieldSubtitle => 'Поле крытэрыю пошуку ў стылі iOS';

  @override
  String get demoCupertinoSearchTextFieldDescription => 'Поле крытэрыю пошуку, якое дазваляе карыстальніку ўводзіць пошукавы тэрмін і прапануе і адфільтроўвае прапановы.';

  @override
  String get demoCupertinoSearchTextFieldPlaceholder => 'Увядзіце пошукавы тэрмін';

  @override
  String get demoCupertinoScrollbarTitle => 'Паласа прагортвання';

  @override
  String get demoCupertinoScrollbarSubtitle => 'Паласа прагортвання ў стылі iOS';

  @override
  String get demoCupertinoScrollbarDescription => 'Паласа прагортвання для дадзенага даччынага элемента';

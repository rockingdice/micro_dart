...
class GalleryLocalizationsMk extends GalleryLocalizations {
  ...
  @override
  String get demoCupertinoPickerDescription => 'Виџет за избор во iOS-стил што може да се користи за избирање низи, датуми, времиња или датум и време заедно.';
  ...
  @override
  String get demoCupertinoSearchTextFieldSubtitle => 'Поле за пребарување текст во iOS-стил';

  @override
  String get demoCupertinoSearchTextFieldDescription => 'Поле за пребарување текст што му овозможува на корисникот да пребарува со внесување текст и што може да понудува и филтрира предлози.';
  ...
  @override
  String get demoCupertinoScrollbarDescription => 'Лента за лизгање што се обвиткува околу подредената ставка';

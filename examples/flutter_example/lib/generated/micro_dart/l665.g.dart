...
'package:collection/src/wrappers.dart@DelegatingIterable@': (m.Scope scope)=>DelegatingIterable,
...
'package:collection/src/wrappers.dart@DelegatingList@': (m.Scope scope)=>DelegatingList,
...
'package:collection/src/wrappers.dart@DelegatingSet@': (m.Scope scope)=>DelegatingSet,
...
'package:collection/src/wrappers.dart@DelegatingQueue@': (m.Scope scope)=>DelegatingQueue,
...
'package:collection/src/wrappers.dart@DelegatingMap@': (m.Scope scope)=>DelegatingMap,
...
'package:collection/src/wrappers.dart@MapKeySet@': (m.Scope scope)=>MapKeySet,

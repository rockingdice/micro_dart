...
'package:flutter/src/widgets/focus_traversal.dart@NumericFocusOrder@': (m.Scope scope)=>NumericFocusOrder,
...
'package:flutter/src/widgets/focus_traversal.dart@LexicalFocusOrder@': (m.Scope scope)=>LexicalFocusOrder,
...
'package:flutter/src/widgets/focus_traversal.dart@FocusTraversalOrder@': (m.Scope scope)=>FocusTraversalOrder,
...
'package:flutter/src/widgets/focus_traversal.dart@FocusTraversalGroup@': (m.Scope scope)=>FocusTraversalGroup,
...
'package:flutter/src/widgets/focus_traversal.dart@RequestFocusIntent@': (m.Scope scope)=>RequestFocusIntent,
...
'package:flutter/src/widgets/focus_traversal.dart@DirectionalFocusIntent@': (m.Scope scope)=>DirectionalFocusIntent,
...
'package:flutter/src/widgets/focus_traversal.dart@ExcludeFocusTraversal@': (m.Scope scope)=>ExcludeFocusTraversal,

...
Map<String, Function> getLibrary(m.MicroDartEngine engine) {
  return {
    'package:flutter/src/cupertino/text_form_field_row.dart@CupertinoTextFormFieldRow@#as':
        (m.Scope scope, target) => () => target as CupertinoTextFormFieldRow,
    'package:flutter/src/cupertino/text_form_field_row.dart@CupertinoTextFormFieldRow@#is':
        (m.Scope scope, target) => () => target is CupertinoTextFormFieldRow,
    'package:flutter/src/cupertino/text_form_field_row.dart@CupertinoTextFormFieldRow@prefix':
        (m.Scope scope, CupertinoTextFormFieldRow target) => target.prefix,
    'package:flutter/src/cupertino/text_form_field_row.dart@CupertinoTextFormFieldRow@padding':
        (m.Scope scope, CupertinoTextFormFieldRow target) => target.padding,
    'package:flutter/src/cupertino/text_form_field_row.dart@CupertinoTextFormFieldRow@controller':
        (m.Scope scope, CupertinoTextFormFieldRow target) => target.controller,
    'package:flutter/src/cupertino/text_form_field_row.dart@CupertinoTextFormFieldRow@':
        (m.Scope scope) => (
              ...
              void onFieldSubmittedProxy(value) {
                engine
                    .callFunctionPointer(scope, onFieldSubmitted!, [value], {});
              }
              ...
              String validatorProxy(value) {
                return engine
                    .callFunctionPointer(scope, validator!, [value], {});
              }
    ...
    'package:flutter/src/cupertino/text_form_field_row.dart@CupertinoTextFormFieldRow@createState':
        (m.Scope scope, CupertinoTextFormFieldRow target) => target.createState,
  };
}

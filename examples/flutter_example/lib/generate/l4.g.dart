...
Map<String, Function> getLibrary(m.MicroDartEngine engine) {
  return {
    ...
    'dart:collection@UnmodifiableListView@': (m.Scope scope) =>
    ...
    'dart:collection@UnmodifiableMapView@': (m.Scope scope) =>
        UnmodifiableMapView,
    ...
    'dart:collection@Queue@#is': (m.Scope scope, target) =>
        () => target is Queue,
    'dart:collection@Queue@': (m.Scope scope) => () {
          return Queue();
        },
    ...
    'dart:collection@DoubleLinkedQueue@': (m.Scope scope) => () {
    ...
    'dart:collection@ListQueue@single': (m.Scope scope, ListQueue target) =>
        target.single,
    'dart:collection@ListQueue@': (m.Scope scope) => ([int? initialCapacity]) {
    ...
    'dart:collection@UnmodifiableSetView@': (m.Scope scope) =>
        UnmodifiableSetView,

...
'dart:core@BigInt@bitLength': (m.Scope scope, BigInt target)=>target.bitLength,
...
'dart:core@BigInt@isNegative': (m.Scope scope, BigInt target)=>target.isNegative,
'dart:core@BigInt@isValidInt': (m.Scope scope, BigInt target)=>target.isValidInt,
...
'dart:core@BigInt@+': (m.Scope scope, BigInt target)=>(other)=> target + other,
'dart:core@BigInt@-': (m.Scope scope, BigInt target)=>(other)=> target - other,
'dart:core@BigInt@*': (m.Scope scope, BigInt target)=>(other)=> target * other,
'dart:core@BigInt@/': (m.Scope scope, BigInt target)=>(other)=> target / other,
'dart:core@BigInt@~/': (m.Scope scope, BigInt target)=>(other)=> target ~/ other,
'dart:core@BigInt@%': (m.Scope scope, BigInt target)=>(other)=> target % other,
'dart:core@BigInt@remainder': (m.Scope scope, BigInt target)=>target.remainder,
'dart:core@BigInt@<<': (m.Scope scope, BigInt target)=>(other)=> target << other,
'dart:core@BigInt@>>': (m.Scope scope, BigInt target)=>(other)=> target >> other,
'dart:core@BigInt@&': (m.Scope scope, BigInt target)=>(other)=> target & other,
'dart:core@BigInt@|': (m.Scope scope, BigInt target)=>(other)=> target | other,
...
'dart:core@BigInt@>': (m.Scope scope, BigInt target)=>(other)=> target > other,
'dart:core@BigInt@>=': (m.Scope scope, BigInt target)=>(other)=> target >= other,
'dart:core@BigInt@compareTo': (m.Scope scope, BigInt target)=>target.compareTo,
...
'dart:core@BigInt@modInverse': (m.Scope scope, BigInt target)=>target.modInverse,
'dart:core@BigInt@gcd': (m.Scope scope, BigInt target)=>target.gcd,
'dart:core@BigInt@toUnsigned': (m.Scope scope, BigInt target)=>target.toUnsigned,
'dart:core@BigInt@toSigned': (m.Scope scope, BigInt target)=>target.toSigned,
'dart:core@BigInt@toInt': (m.Scope scope, BigInt target)=>target.toInt,
'dart:core@BigInt@toDouble': (m.Scope scope, BigInt target)=>target.toDouble,
'dart:core@BigInt@toString': (m.Scope scope, BigInt target)=>target.toString,
'dart:core@BigInt@toRadixString': (m.Scope scope, BigInt target)=>target.toRadixString,
...
'dart:core@bool@&': (m.Scope scope, bool target)=>(other)=> target & other,
'dart:core@bool@|': (m.Scope scope, bool target)=>(other)=> target | other,
'dart:core@bool@^': (m.Scope scope, bool target)=>(other)=> target ^ other,
'dart:core@bool@toString': (m.Scope scope, bool target)=>target.toString,
'dart:core@Comparable@#as': (m.Scope scope, target)=>()=>target as Comparable,
'dart:core@Comparable@#is': (m.Scope scope, target)=>()=>target is Comparable,
'dart:core@Comparable@compareTo': (m.Scope scope, Comparable target)=>target.compareTo,
'dart:core@Comparable@compare': (m.Scope scope)=>Comparable.compare,
'dart:core@DateTime@#as': (m.Scope scope, target)=>()=>target as DateTime,
'dart:core@DateTime@#is': (m.Scope scope, target)=>()=>target is DateTime,
...
'dart:core@DateTime@monthsPerYear': (m.Scope scope)=>DateTime.monthsPerYear,
'dart:core@DateTime@isUtc': (m.Scope scope, DateTime target)=>target.isUtc,
'dart:core@DateTime@hashCode': (m.Scope scope, DateTime target)=>target.hashCode,
'dart:core@DateTime@millisecondsSinceEpoch': (m.Scope scope, DateTime target)=>target.millisecondsSinceEpoch,
'dart:core@DateTime@microsecondsSinceEpoch': (m.Scope scope, DateTime target)=>target.microsecondsSinceEpoch,
'dart:core@DateTime@timeZoneName': (m.Scope scope, DateTime target)=>target.timeZoneName,
'dart:core@DateTime@timeZoneOffset': (m.Scope scope, DateTime target)=>target.timeZoneOffset,
'dart:core@DateTime@year': (m.Scope scope, DateTime target)=>target.year,
'dart:core@DateTime@month': (m.Scope scope, DateTime target)=>target.month,
...
'dart:core@DateTime@minute': (m.Scope scope, DateTime target)=>target.minute,
'dart:core@DateTime@second': (m.Scope scope, DateTime target)=>target.second,
...
'dart:core@DateTime@fromMillisecondsSinceEpoch': (m.Scope scope)=>DateTime.fromMillisecondsSinceEpoch,
'dart:core@DateTime@fromMicrosecondsSinceEpoch': (m.Scope scope)=>DateTime.fromMicrosecondsSinceEpoch,
'dart:core@DateTime@parse': (m.Scope scope)=>DateTime.parse,
'dart:core@DateTime@tryParse': (m.Scope scope)=>DateTime.tryParse,
'dart:core@DateTime@==': (m.Scope scope, DateTime target)=>(other)=> target == other,
'dart:core@DateTime@isBefore': (m.Scope scope, DateTime target)=>target.isBefore,
'dart:core@DateTime@isAfter': (m.Scope scope, DateTime target)=>target.isAfter,
'dart:core@DateTime@isAtSameMomentAs': (m.Scope scope, DateTime target)=>target.isAtSameMomentAs,
'dart:core@DateTime@compareTo': (m.Scope scope, DateTime target)=>target.compareTo,
'dart:core@DateTime@toLocal': (m.Scope scope, DateTime target)=>target.toLocal,
'dart:core@DateTime@toUtc': (m.Scope scope, DateTime target)=>target.toUtc,
'dart:core@DateTime@toString': (m.Scope scope, DateTime target)=>target.toString,
'dart:core@DateTime@toIso8601String': (m.Scope scope, DateTime target)=>target.toIso8601String,
'dart:core@DateTime@add': (m.Scope scope, DateTime target)=>target.add,
'dart:core@DateTime@subtract': (m.Scope scope, DateTime target)=>target.subtract,
'dart:core@DateTime@difference': (m.Scope scope, DateTime target)=>target.difference,
...
'dart:core@double@negativeInfinity': (m.Scope scope)=>double.negativeInfinity,
...
'dart:core@double@remainder': (m.Scope scope, double target)=>target.remainder,
'dart:core@double@+': (m.Scope scope, double target)=>(other)=> target + other,
'dart:core@double@-': (m.Scope scope, double target)=>(other)=> target - other,
'dart:core@double@*': (m.Scope scope, double target)=>(other)=> target * other,
'dart:core@double@%': (m.Scope scope, double target)=>(other)=> target % other,
'dart:core@double@/': (m.Scope scope, double target)=>(other)=> target / other,
...
'dart:core@double@truncate': (m.Scope scope, double target)=>target.truncate,
'dart:core@double@roundToDouble': (m.Scope scope, double target)=>target.roundToDouble,
'dart:core@double@floorToDouble': (m.Scope scope, double target)=>target.floorToDouble,
'dart:core@double@ceilToDouble': (m.Scope scope, double target)=>target.ceilToDouble,
'dart:core@double@truncateToDouble': (m.Scope scope, double target)=>target.truncateToDouble,
'dart:core@double@toString': (m.Scope scope, double target)=>target.toString,
'dart:core@double@parse': (m.Scope scope)=>double.parse,
'dart:core@double@tryParse': (m.Scope scope)=>double.tryParse,
'dart:core@Duration@#as': (m.Scope scope, target)=>()=>target as Duration,
'dart:core@Duration@#is': (m.Scope scope, target)=>()=>target is Duration,
'dart:core@Duration@microsecondsPerMillisecond': (m.Scope scope)=>Duration.microsecondsPerMillisecond,
'dart:core@Duration@millisecondsPerSecond': (m.Scope scope)=>Duration.millisecondsPerSecond,
'dart:core@Duration@secondsPerMinute': (m.Scope scope)=>Duration.secondsPerMinute,
'dart:core@Duration@minutesPerHour': (m.Scope scope)=>Duration.minutesPerHour,
'dart:core@Duration@hoursPerDay': (m.Scope scope)=>Duration.hoursPerDay,
'dart:core@Duration@microsecondsPerSecond': (m.Scope scope)=>Duration.microsecondsPerSecond,
'dart:core@Duration@microsecondsPerMinute': (m.Scope scope)=>Duration.microsecondsPerMinute,
'dart:core@Duration@microsecondsPerHour': (m.Scope scope)=>Duration.microsecondsPerHour,
'dart:core@Duration@microsecondsPerDay': (m.Scope scope)=>Duration.microsecondsPerDay,
'dart:core@Duration@millisecondsPerMinute': (m.Scope scope)=>Duration.millisecondsPerMinute,
'dart:core@Duration@millisecondsPerHour': (m.Scope scope)=>Duration.millisecondsPerHour,
'dart:core@Duration@millisecondsPerDay': (m.Scope scope)=>Duration.millisecondsPerDay,
'dart:core@Duration@secondsPerHour': (m.Scope scope)=>Duration.secondsPerHour,
'dart:core@Duration@secondsPerDay': (m.Scope scope)=>Duration.secondsPerDay,
'dart:core@Duration@minutesPerDay': (m.Scope scope)=>Duration.minutesPerDay,
'dart:core@Duration@zero': (m.Scope scope)=>Duration.zero,
'dart:core@Duration@inDays': (m.Scope scope, Duration target)=>target.inDays,
'dart:core@Duration@inHours': (m.Scope scope, Duration target)=>target.inHours,
'dart:core@Duration@inMinutes': (m.Scope scope, Duration target)=>target.inMinutes,
'dart:core@Duration@inSeconds': (m.Scope scope, Duration target)=>target.inSeconds,
'dart:core@Duration@inMilliseconds': (m.Scope scope, Duration target)=>target.inMilliseconds,
'dart:core@Duration@inMicroseconds': (m.Scope scope, Duration target)=>target.inMicroseconds,
'dart:core@Duration@hashCode': (m.Scope scope, Duration target)=>target.hashCode,
'dart:core@Duration@isNegative': (m.Scope scope, Duration target)=>target.isNegative,
'dart:core@Duration@': (m.Scope scope)=>({ days,  hours,  microseconds,  milliseconds,  minutes,  seconds}){
return Duration(days:days ?? 0, hours:hours ?? 0, microseconds:microseconds ?? 0, milliseconds:milliseconds ?? 0, minutes:minutes ?? 0, seconds:seconds ?? 0);
},
'dart:core@Duration@+': (m.Scope scope, Duration target)=>(other)=> target + other,
'dart:core@Duration@-': (m.Scope scope, Duration target)=>(other)=> target - other,
'dart:core@Duration@*': (m.Scope scope, Duration target)=>(other)=> target * other,
'dart:core@Duration@~/': (m.Scope scope, Duration target)=>(other)=> target ~/ other,
'dart:core@Duration@<': (m.Scope scope, Duration target)=>(other)=> target < other,
...
'dart:core@Duration@>=': (m.Scope scope, Duration target)=>(other)=> target >= other,
'dart:core@Duration@==': (m.Scope scope, Duration target)=>(other)=> target == other,
'dart:core@Duration@compareTo': (m.Scope scope, Duration target)=>target.compareTo,
'dart:core@Duration@toString': (m.Scope scope, Duration target)=>target.toString,
'dart:core@Duration@abs': (m.Scope scope, Duration target)=>target.abs,
'dart:core@Duration@unary-': (m.Scope scope, Duration target)=>()=> - target ,
...
'dart:core@Error@stackTrace': (m.Scope scope, Error target)=>target.stackTrace,
'dart:core@Error@': (m.Scope scope)=>(){
return Error();
},
'dart:core@Error@safeToString': (m.Scope scope)=>Error.safeToString,
'dart:core@Error@throwWithStackTrace': (m.Scope scope)=>Error.throwWithStackTrace,
'dart:core@AssertionError@#as': (m.Scope scope, target)=>()=>target as AssertionError,
'dart:core@AssertionError@#is': (m.Scope scope, target)=>()=>target is AssertionError,
'dart:core@AssertionError@message': (m.Scope scope, AssertionError target)=>target.message,
...
'dart:core@AssertionError@toString': (m.Scope scope, AssertionError target)=>target.toString,
'dart:core@TypeError@#as': (m.Scope scope, target)=>()=>target as TypeError,
'dart:core@TypeError@#is': (m.Scope scope, target)=>()=>target is TypeError,
'dart:core@TypeError@': (m.Scope scope)=>(){
return TypeError();
},
'dart:core@ArgumentError@#as': (m.Scope scope, target)=>()=>target as ArgumentError,
'dart:core@ArgumentError@#is': (m.Scope scope, target)=>()=>target is ArgumentError,
'dart:core@ArgumentError@invalidValue': (m.Scope scope, ArgumentError target)=>target.invalidValue,
'dart:core@ArgumentError@name': (m.Scope scope, ArgumentError target)=>target.name,
'dart:core@ArgumentError@message': (m.Scope scope, ArgumentError target)=>target.message,
'dart:core@ArgumentError@': (m.Scope scope)=>([dynamic message, String? name]){
...
'dart:core@ArgumentError@checkNotNull': (m.Scope scope)=>ArgumentError.checkNotNull,
'dart:core@ArgumentError@toString': (m.Scope scope, ArgumentError target)=>target.toString,
'dart:core@RangeError@#as': (m.Scope scope, target)=>()=>target as RangeError,
'dart:core@RangeError@#is': (m.Scope scope, target)=>()=>target is RangeError,
...
'dart:core@RangeError@checkValueInInterval': (m.Scope scope)=>RangeError.checkValueInInterval,
'dart:core@RangeError@checkValidIndex': (m.Scope scope)=>RangeError.checkValidIndex,
'dart:core@RangeError@checkValidRange': (m.Scope scope)=>RangeError.checkValidRange,
'dart:core@RangeError@checkNotNegative': (m.Scope scope)=>RangeError.checkNotNegative,
'dart:core@IndexError@#as': (m.Scope scope, target)=>()=>target as IndexError,
'dart:core@IndexError@#is': (m.Scope scope, target)=>()=>target is IndexError,
'dart:core@IndexError@indexable': (m.Scope scope, IndexError target)=>target.indexable,
'dart:core@IndexError@length': (m.Scope scope, IndexError target)=>target.length,
'dart:core@IndexError@invalidValue': (m.Scope scope, IndexError target)=>target.invalidValue,
'dart:core@IndexError@start': (m.Scope scope, IndexError target)=>target.start,
'dart:core@IndexError@end': (m.Scope scope, IndexError target)=>target.end,
...
'dart:core@NoSuchMethodError@#as': (m.Scope scope, target)=>()=>target as NoSuchMethodError,
'dart:core@NoSuchMethodError@#is': (m.Scope scope, target)=>()=>target is NoSuchMethodError,
'dart:core@NoSuchMethodError@withInvocation': (m.Scope scope)=>NoSuchMethodError.withInvocation,
'dart:core@NoSuchMethodError@toString': (m.Scope scope, NoSuchMethodError target)=>target.toString,
...
'dart:core@UnimplementedError@message': (m.Scope scope, UnimplementedError target)=>target.message,
...
'dart:core@UnimplementedError@toString': (m.Scope scope, UnimplementedError target)=>target.toString,
...
'dart:core@ConcurrentModificationError@modifiedObject': (m.Scope scope, ConcurrentModificationError target)=>target.modifiedObject,
'dart:core@ConcurrentModificationError@': (m.Scope scope)=>([Object? modifiedObject]){
if(modifiedObject == null){
return ConcurrentModificationError();
}
return ConcurrentModificationError(modifiedObject!);
},
'dart:core@ConcurrentModificationError@toString': (m.Scope scope, ConcurrentModificationError target)=>target.toString,
'dart:core@OutOfMemoryError@#as': (m.Scope scope, target)=>()=>target as OutOfMemoryError,
'dart:core@OutOfMemoryError@#is': (m.Scope scope, target)=>()=>target is OutOfMemoryError,
'dart:core@OutOfMemoryError@stackTrace': (m.Scope scope, OutOfMemoryError target)=>target.stackTrace,
'dart:core@OutOfMemoryError@': (m.Scope scope)=>(){
return OutOfMemoryError();
},
'dart:core@OutOfMemoryError@toString': (m.Scope scope, OutOfMemoryError target)=>target.toString,
'dart:core@StackOverflowError@#as': (m.Scope scope, target)=>()=>target as StackOverflowError,
'dart:core@StackOverflowError@#is': (m.Scope scope, target)=>()=>target is StackOverflowError,
'dart:core@StackOverflowError@stackTrace': (m.Scope scope, StackOverflowError target)=>target.stackTrace,
'dart:core@StackOverflowError@': (m.Scope scope)=>(){
return StackOverflowError();
},
'dart:core@StackOverflowError@toString': (m.Scope scope, StackOverflowError target)=>target.toString,
'dart:core@Exception@#as': (m.Scope scope, target)=>()=>target as Exception,
'dart:core@Exception@#is': (m.Scope scope, target)=>()=>target is Exception,
...
'dart:core@FormatException@#as': (m.Scope scope, target)=>()=>target as FormatException,
'dart:core@FormatException@#is': (m.Scope scope, target)=>()=>target is FormatException,
'dart:core@FormatException@message': (m.Scope scope, FormatException target)=>target.message,
'dart:core@FormatException@source': (m.Scope scope, FormatException target)=>target.source,
'dart:core@FormatException@offset': (m.Scope scope, FormatException target)=>target.offset,
'dart:core@FormatException@': (m.Scope scope)=>([String? message, dynamic source, int? offset]){
...
'dart:core@FormatException@toString': (m.Scope scope, FormatException target)=>target.toString,
'dart:core@IntegerDivisionByZeroException@#as': (m.Scope scope, target)=>()=>target as IntegerDivisionByZeroException,
'dart:core@IntegerDivisionByZeroException@#is': (m.Scope scope, target)=>()=>target is IntegerDivisionByZeroException,
'dart:core@IntegerDivisionByZeroException@message': (m.Scope scope, IntegerDivisionByZeroException target)=>target.message,
'dart:core@IntegerDivisionByZeroException@stackTrace': (m.Scope scope, IntegerDivisionByZeroException target)=>target.stackTrace,
'dart:core@IntegerDivisionByZeroException@': (m.Scope scope)=>(){
return IntegerDivisionByZeroException();
},
'dart:core@IntegerDivisionByZeroException@toString': (m.Scope scope, IntegerDivisionByZeroException target)=>target.toString,
'dart:core@Function@#as': (m.Scope scope, target)=>()=>target as Function,
'dart:core@Function@#is': (m.Scope scope, target)=>()=>target is Function,
'dart:core@Function@hashCode': (m.Scope scope, Function target)=>target.hashCode,
'dart:core@Function@apply': (m.Scope scope)=>Function.apply,
'dart:core@Function@==': (m.Scope scope, Function target)=>(other)=> target == other,
...
'dart:core@int@modInverse': (m.Scope scope, int target)=>target.modInverse,
'dart:core@int@gcd': (m.Scope scope, int target)=>target.gcd,
'dart:core@int@toUnsigned': (m.Scope scope, int target)=>target.toUnsigned,
...
'dart:core@int@roundToDouble': (m.Scope scope, int target)=>target.roundToDouble,
'dart:core@int@floorToDouble': (m.Scope scope, int target)=>target.floorToDouble,
'dart:core@int@ceilToDouble': (m.Scope scope, int target)=>target.ceilToDouble,
'dart:core@int@truncateToDouble': (m.Scope scope, int target)=>target.truncateToDouble,
'dart:core@int@toString': (m.Scope scope, int target)=>target.toString,
'dart:core@int@toRadixString': (m.Scope scope, int target)=>target.toRadixString,
'dart:core@int@parse': (m.Scope scope)=>int.parse,
'dart:core@int@tryParse': (m.Scope scope)=>int.tryParse,
'dart:core@Invocation@#as': (m.Scope scope, target)=>()=>target as Invocation,
'dart:core@Invocation@#is': (m.Scope scope, target)=>()=>target is Invocation,
'dart:core@Invocation@memberName': (m.Scope scope, Invocation target)=>target.memberName,
'dart:core@Invocation@typeArguments': (m.Scope scope, Invocation target)=>target.typeArguments,
'dart:core@Invocation@positionalArguments': (m.Scope scope, Invocation target)=>target.positionalArguments,
'dart:core@Invocation@namedArguments': (m.Scope scope, Invocation target)=>target.namedArguments,
'dart:core@Invocation@isMethod': (m.Scope scope, Invocation target)=>target.isMethod,
'dart:core@Invocation@isGetter': (m.Scope scope, Invocation target)=>target.isGetter,
'dart:core@Invocation@isSetter': (m.Scope scope, Invocation target)=>target.isSetter,
'dart:core@Invocation@isAccessor': (m.Scope scope, Invocation target)=>target.isAccessor,
'dart:core@Invocation@method': (m.Scope scope)=>Invocation.method,
'dart:core@Invocation@genericMethod': (m.Scope scope)=>Invocation.genericMethod,
'dart:core@Invocation@getter': (m.Scope scope)=>Invocation.getter,
'dart:core@Invocation@setter': (m.Scope scope)=>Invocation.setter,
'dart:core@Iterable@#as': (m.Scope scope, target)=>()=>target as Iterable,
'dart:core@Iterable@#is': (m.Scope scope, target)=>()=>target is Iterable,
'dart:core@Iterable@iterator': (m.Scope scope, Iterable target)=>target.iterator,
'dart:core@Iterable@length': (m.Scope scope, Iterable target)=>target.length,
'dart:core@Iterable@isEmpty': (m.Scope scope, Iterable target)=>target.isEmpty,
'dart:core@Iterable@isNotEmpty': (m.Scope scope, Iterable target)=>target.isNotEmpty,
'dart:core@Iterable@first': (m.Scope scope, Iterable target)=>target.first,
'dart:core@Iterable@last': (m.Scope scope, Iterable target)=>target.last,
'dart:core@Iterable@single': (m.Scope scope, Iterable target)=>target.single,
'dart:core@Iterable@generate': (m.Scope scope)=>( count, [m.FunctionPointer? generator]){
if(generator == null){
...
'dart:core@Iterable@followedBy': (m.Scope scope, Iterable target)=>target.followedBy,
...
'dart:core@Iterable@whereType': (m.Scope scope, Iterable target)=>target.whereType,
'dart:core@Iterable@expand': (m.Scope scope, Iterable target)=>( toElements){
...
'dart:core@Iterable@contains': (m.Scope scope, Iterable target)=>target.contains,
...
return  engine.callFunctionPointer(scope, combine!,[value, element], {});
}

return target.reduce(combineProxy);
},
'dart:core@Iterable@fold': (m.Scope scope, Iterable target)=>( initialValue,  combine){
T combineProxy<T, E>( previousValue,  element) {
return  engine.callFunctionPointer(scope, combine!,[previousValue, element], {});
}
...
'dart:core@Iterable@toList': (m.Scope scope, Iterable target)=>target.toList,
'dart:core@Iterable@toSet': (m.Scope scope, Iterable target)=>target.toSet,
...
'dart:core@Iterable@firstWhere': (m.Scope scope, Iterable target)=>( test, { orElse}){
bool testProxy<E>( element) {
return  engine.callFunctionPointer(scope, test!,[element], {});
}
...
'dart:core@Iterable@lastWhere': (m.Scope scope, Iterable target)=>( test, { orElse}){
bool testProxy<E>( element) {
return  engine.callFunctionPointer(scope, test!,[element], {});
}
...
'dart:core@Iterable@singleWhere': (m.Scope scope, Iterable target)=>( test, { orElse}){
bool testProxy<E>( element) {
return  engine.callFunctionPointer(scope, test!,[element], {});
}
...
'dart:core@Iterable@elementAt': (m.Scope scope, Iterable target)=>target.elementAt,
'dart:core@Iterable@toString': (m.Scope scope, Iterable target)=>target.toString,
'dart:core@Iterable@iterableToShortString': (m.Scope scope)=>Iterable.iterableToShortString,
'dart:core@Iterable@iterableToFullString': (m.Scope scope)=>Iterable.iterableToFullString,
'dart:core@Iterator@#as': (m.Scope scope, target)=>()=>target as Iterator,
'dart:core@Iterator@#is': (m.Scope scope, target)=>()=>target is Iterator,
'dart:core@Iterator@current': (m.Scope scope, Iterator target)=>target.current,
'dart:core@Iterator@moveNext': (m.Scope scope, Iterator target)=>target.moveNext,
'dart:core@List@#as': (m.Scope scope, target)=>()=>target as List,
'dart:core@List@#is': (m.Scope scope, target)=>()=>target is List,
'dart:core@List@first:set': (m.Scope scope, List target)=>(other)=>target.first=other,
'dart:core@List@last:set': (m.Scope scope, List target)=>(other)=>target.last=other,
'dart:core@List@length': (m.Scope scope, List target)=>target.length,
'dart:core@List@length:set': (m.Scope scope, List target)=>(other)=>target.length=other,
...
'dart:core@List@generate': (m.Scope scope)=>( length,  generator, { growable}){
E generatorProxy<E>( index) {
return  engine.callFunctionPointer(scope, generator!,[index], {});
}

return List.generate(length, generatorProxy, growable:growable ?? true);
},
...
'dart:core@List@[]': (m.Scope scope, List target)=>(index)=> target[index],
'dart:core@List@[]=': (m.Scope scope, List target)=>(index,other)=> target[index] = other,
'dart:core@List@add': (m.Scope scope, List target)=>target.add,
'dart:core@List@addAll': (m.Scope scope, List target)=>target.addAll,
'dart:core@List@sort': (m.Scope scope, List target)=>([m.FunctionPointer? compare]){
if(compare == null){
target.sort();
return;
}
...
'dart:core@List@indexWhere': (m.Scope scope, List target)=>( test, [int? start]){
bool testProxy<E>( element) {
return  engine.callFunctionPointer(scope, test!,[element], {});
}
...
'dart:core@List@lastIndexWhere': (m.Scope scope, List target)=>( test, [int? start]){
bool testProxy<E>( element) {
return  engine.callFunctionPointer(scope, test!,[element], {});
}
...
'dart:core@List@lastIndexOf': (m.Scope scope, List target)=>target.lastIndexOf,
'dart:core@List@clear': (m.Scope scope, List target)=>target.clear,
'dart:core@List@insert': (m.Scope scope, List target)=>target.insert,
'dart:core@List@insertAll': (m.Scope scope, List target)=>target.insertAll,
...
'dart:core@List@removeLast': (m.Scope scope, List target)=>target.removeLast,
...
'dart:core@List@+': (m.Scope scope, List target)=>(other)=> target + other,
...
'dart:core@List@removeRange': (m.Scope scope, List target)=>target.removeRange,
'dart:core@List@fillRange': (m.Scope scope, List target)=>target.fillRange,
'dart:core@List@replaceRange': (m.Scope scope, List target)=>target.replaceRange,
...
'dart:core@Map@isNotEmpty': (m.Scope scope, Map target)=>target.isNotEmpty,
'dart:core@Map@': (m.Scope scope)=>(){
return Map();
},
...
return Map.fromIterable(iterable, key:key == null ? null :keyProxy, value:value == null ? null :valueProxy);
},
...
'dart:core@Map@containsValue': (m.Scope scope, Map target)=>target.containsValue,
'dart:core@Map@containsKey': (m.Scope scope, Map target)=>target.containsKey,
'dart:core@Map@[]': (m.Scope scope, Map target)=>(index)=> target[index],
'dart:core@Map@[]=': (m.Scope scope, Map target)=>(index,other)=> target[index] = other,
'dart:core@Map@map': (m.Scope scope, Map target)=>( convert){
MapEntry<K2, V2> convertProxy<K2, V2, K, V>( key,  value) {
return  engine.callFunctionPointer(scope, convert!,[key, value], {});
}

return target.map(convertProxy);
},
'dart:core@Map@addEntries': (m.Scope scope, Map target)=>target.addEntries,
'dart:core@Map@update': (m.Scope scope, Map target)=>( key,  update, { ifAbsent}){
...
'dart:core@Map@putIfAbsent': (m.Scope scope, Map target)=>( key,  ifAbsent){
V ifAbsentProxy<V>() {
return  engine.callFunctionPointer(scope, ifAbsent!,[], {});
}
...
'dart:core@MapEntry@#as': (m.Scope scope, target)=>()=>target as MapEntry,
...
'dart:core@num@isNegative': (m.Scope scope, num target)=>target.isNegative,
'dart:core@num@isInfinite': (m.Scope scope, num target)=>target.isInfinite,
...
'dart:core@num@roundToDouble': (m.Scope scope, num target)=>target.roundToDouble,
'dart:core@num@floorToDouble': (m.Scope scope, num target)=>target.floorToDouble,
'dart:core@num@ceilToDouble': (m.Scope scope, num target)=>target.ceilToDouble,
'dart:core@num@truncateToDouble': (m.Scope scope, num target)=>target.truncateToDouble,
...
'dart:core@num@toStringAsFixed': (m.Scope scope, num target)=>target.toStringAsFixed,
'dart:core@num@toStringAsExponential': (m.Scope scope, num target)=>target.toStringAsExponential,
'dart:core@num@toStringAsPrecision': (m.Scope scope, num target)=>target.toStringAsPrecision,
'dart:core@num@toString': (m.Scope scope, num target)=>target.toString,
'dart:core@num@parse': (m.Scope scope)=>( input, [m.FunctionPointer? onError]){
if(onError == null){
...
'dart:core@Object@hashCode': (m.Scope scope, Object target)=>target.hashCode,
'dart:core@Object@runtimeType': (m.Scope scope, Object target)=>target.runtimeType,
'dart:core@Object@': (m.Scope scope)=>(){
return Object();
},
'dart:core@Object@==': (m.Scope scope, Object target)=>(other)=> target == other,
'dart:core@Object@toString': (m.Scope scope, Object target)=>target.toString,
'dart:core@Object@noSuchMethod': (m.Scope scope, Object target)=>target.noSuchMethod,
'dart:core@Object@hash': (m.Scope scope)=>Object.hash,
'dart:core@Object@hashAll': (m.Scope scope)=>Object.hashAll,
'dart:core@Object@hashAllUnordered': (m.Scope scope)=>Object.hashAllUnordered,
'dart:core@Pattern@#as': (m.Scope scope, target)=>()=>target as Pattern,
'dart:core@Pattern@#is': (m.Scope scope, target)=>()=>target is Pattern,
'dart:core@Pattern@allMatches': (m.Scope scope, Pattern target)=>target.allMatches,
'dart:core@Pattern@matchAsPrefix': (m.Scope scope, Pattern target)=>target.matchAsPrefix,
...
'dart:core@Match@groupCount': (m.Scope scope, Match target)=>target.groupCount,
...
'dart:core@Match@[]': (m.Scope scope, Match target)=>(index)=> target[index],
...
'dart:core@RegExp@pattern': (m.Scope scope, RegExp target)=>target.pattern,
'dart:core@RegExp@isMultiLine': (m.Scope scope, RegExp target)=>target.isMultiLine,
...
'dart:core@RegExp@hasMatch': (m.Scope scope, RegExp target)=>target.hasMatch,
'dart:core@RegExp@stringMatch': (m.Scope scope, RegExp target)=>target.stringMatch,
'dart:core@RegExpMatch@#as': (m.Scope scope, target)=>()=>target as RegExpMatch,
'dart:core@RegExpMatch@#is': (m.Scope scope, target)=>()=>target is RegExpMatch,
'dart:core@RegExpMatch@groupNames': (m.Scope scope, RegExpMatch target)=>target.groupNames,
'dart:core@RegExpMatch@pattern': (m.Scope scope, RegExpMatch target)=>target.pattern,
'dart:core@RegExpMatch@namedGroup': (m.Scope scope, RegExpMatch target)=>target.namedGroup,
...
return Set.castFrom(source, newSet:newSet == null ? null :newSetProxy);
},
...
'dart:core@Set@containsAll': (m.Scope scope, Set target)=>target.containsAll,
'dart:core@Set@intersection': (m.Scope scope, Set target)=>target.intersection,
'dart:core@Set@union': (m.Scope scope, Set target)=>target.union,
'dart:core@Set@difference': (m.Scope scope, Set target)=>target.difference,
...
'dart:core@StackTrace@#as': (m.Scope scope, target)=>()=>target as StackTrace,
'dart:core@StackTrace@#is': (m.Scope scope, target)=>()=>target is StackTrace,
...
'dart:core@StackTrace@toString': (m.Scope scope, StackTrace target)=>target.toString,
'dart:core@Stopwatch@#as': (m.Scope scope, target)=>()=>target as Stopwatch,
'dart:core@Stopwatch@#is': (m.Scope scope, target)=>()=>target is Stopwatch,
'dart:core@Stopwatch@frequency': (m.Scope scope, Stopwatch target)=>target.frequency,
'dart:core@Stopwatch@elapsedTicks': (m.Scope scope, Stopwatch target)=>target.elapsedTicks,
'dart:core@Stopwatch@elapsed': (m.Scope scope, Stopwatch target)=>target.elapsed,
'dart:core@Stopwatch@elapsedMicroseconds': (m.Scope scope, Stopwatch target)=>target.elapsedMicroseconds,
'dart:core@Stopwatch@elapsedMilliseconds': (m.Scope scope, Stopwatch target)=>target.elapsedMilliseconds,
'dart:core@Stopwatch@isRunning': (m.Scope scope, Stopwatch target)=>target.isRunning,
'dart:core@Stopwatch@': (m.Scope scope)=>(){
return Stopwatch();
},
'dart:core@Stopwatch@start': (m.Scope scope, Stopwatch target)=>target.start,
'dart:core@Stopwatch@stop': (m.Scope scope, Stopwatch target)=>target.stop,
'dart:core@Stopwatch@reset': (m.Scope scope, Stopwatch target)=>target.reset,
...
'dart:core@String@hashCode': (m.Scope scope, String target)=>target.hashCode,
'dart:core@String@isEmpty': (m.Scope scope, String target)=>target.isEmpty,
'dart:core@String@isNotEmpty': (m.Scope scope, String target)=>target.isNotEmpty,
'dart:core@String@codeUnits': (m.Scope scope, String target)=>target.codeUnits,
...
'dart:core@String@fromEnvironment': (m.Scope scope)=>String.fromEnvironment,
'dart:core@String@[]': (m.Scope scope, String target)=>(index)=> target[index],
'dart:core@String@codeUnitAt': (m.Scope scope, String target)=>target.codeUnitAt,
'dart:core@String@==': (m.Scope scope, String target)=>(other)=> target == other,
'dart:core@String@compareTo': (m.Scope scope, String target)=>target.compareTo,
'dart:core@String@endsWith': (m.Scope scope, String target)=>target.endsWith,
'dart:core@String@startsWith': (m.Scope scope, String target)=>target.startsWith,
'dart:core@String@indexOf': (m.Scope scope, String target)=>target.indexOf,
'dart:core@String@lastIndexOf': (m.Scope scope, String target)=>target.lastIndexOf,
'dart:core@String@+': (m.Scope scope, String target)=>(other)=> target + other,
'dart:core@String@substring': (m.Scope scope, String target)=>target.substring,
'dart:core@String@trim': (m.Scope scope, String target)=>target.trim,
'dart:core@String@trimLeft': (m.Scope scope, String target)=>target.trimLeft,
'dart:core@String@trimRight': (m.Scope scope, String target)=>target.trimRight,
'dart:core@String@*': (m.Scope scope, String target)=>(other)=> target * other,
'dart:core@String@padLeft': (m.Scope scope, String target)=>target.padLeft,
'dart:core@String@padRight': (m.Scope scope, String target)=>target.padRight,
'dart:core@String@contains': (m.Scope scope, String target)=>target.contains,
'dart:core@String@replaceFirst': (m.Scope scope, String target)=>target.replaceFirst,
'dart:core@String@replaceFirstMapped': (m.Scope scope, String target)=>( from,  replace, [int? startIndex]){
...
'dart:core@String@replaceAll': (m.Scope scope, String target)=>target.replaceAll,
'dart:core@String@replaceAllMapped': (m.Scope scope, String target)=>( from,  replace){
String replaceProxy( match) {
return  engine.callFunctionPointer(scope, replace!,[match], {});
}
...
'dart:core@String@replaceRange': (m.Scope scope, String target)=>target.replaceRange,
'dart:core@String@split': (m.Scope scope, String target)=>target.split,
'dart:core@String@splitMapJoin': (m.Scope scope, String target)=>( pattern, { onMatch,  onNonMatch}){
...
return target.splitMapJoin(pattern, onMatch:onMatch == null ? null :onMatchProxy, onNonMatch:onNonMatch == null ? null :onNonMatchProxy);
},
'dart:core@String@toLowerCase': (m.Scope scope, String target)=>target.toLowerCase,
'dart:core@String@toUpperCase': (m.Scope scope, String target)=>target.toUpperCase,
...
'dart:core@RuneIterator@rawIndex': (m.Scope scope, RuneIterator target)=>target.rawIndex,
'dart:core@RuneIterator@rawIndex:set': (m.Scope scope, RuneIterator target)=>(other)=>target.rawIndex=other,
...
'dart:core@RuneIterator@movePrevious': (m.Scope scope, RuneIterator target)=>target.movePrevious,
'dart:core@StringBuffer@#as': (m.Scope scope, target)=>()=>target as StringBuffer,
'dart:core@StringBuffer@#is': (m.Scope scope, target)=>()=>target is StringBuffer,
'dart:core@StringBuffer@length': (m.Scope scope, StringBuffer target)=>target.length,
'dart:core@StringBuffer@isEmpty': (m.Scope scope, StringBuffer target)=>target.isEmpty,
'dart:core@StringBuffer@isNotEmpty': (m.Scope scope, StringBuffer target)=>target.isNotEmpty,
...
'dart:core@StringBuffer@write': (m.Scope scope, StringBuffer target)=>target.write,
'dart:core@StringBuffer@writeCharCode': (m.Scope scope, StringBuffer target)=>target.writeCharCode,
'dart:core@StringBuffer@writeAll': (m.Scope scope, StringBuffer target)=>target.writeAll,
'dart:core@StringBuffer@writeln': (m.Scope scope, StringBuffer target)=>target.writeln,
'dart:core@StringBuffer@clear': (m.Scope scope, StringBuffer target)=>target.clear,
'dart:core@StringBuffer@toString': (m.Scope scope, StringBuffer target)=>target.toString,
'dart:core@StringSink@#as': (m.Scope scope, target)=>()=>target as StringSink,
'dart:core@StringSink@#is': (m.Scope scope, target)=>()=>target is StringSink,
'dart:core@StringSink@write': (m.Scope scope, StringSink target)=>target.write,
'dart:core@StringSink@writeAll': (m.Scope scope, StringSink target)=>target.writeAll,
'dart:core@StringSink@writeln': (m.Scope scope, StringSink target)=>target.writeln,
'dart:core@StringSink@writeCharCode': (m.Scope scope, StringSink target)=>target.writeCharCode,
...
'dart:core@Type@==': (m.Scope scope, Type target)=>(other)=> target == other,
...
'dart:core@Uri@pathSegments': (m.Scope scope, Uri target)=>target.pathSegments,
'dart:core@Uri@queryParameters': (m.Scope scope, Uri target)=>target.queryParameters,
'dart:core@Uri@queryParametersAll': (m.Scope scope, Uri target)=>target.queryParametersAll,
'dart:core@Uri@isAbsolute': (m.Scope scope, Uri target)=>target.isAbsolute,
'dart:core@Uri@hasScheme': (m.Scope scope, Uri target)=>target.hasScheme,
'dart:core@Uri@hasAuthority': (m.Scope scope, Uri target)=>target.hasAuthority,
...
'dart:core@Uri@hasFragment': (m.Scope scope, Uri target)=>target.hasFragment,
'dart:core@Uri@hasEmptyPath': (m.Scope scope, Uri target)=>target.hasEmptyPath,
'dart:core@Uri@hasAbsolutePath': (m.Scope scope, Uri target)=>target.hasAbsolutePath,
...
'dart:core@Uri@': (m.Scope scope)=>({ fragment,  host,  path,  pathSegments,  port,  query,  queryParameters,  scheme,  userInfo}){
return Uri(fragment:fragment, host:host, path:path, pathSegments:pathSegments, port:port, query:query, queryParameters:queryParameters, scheme:scheme, userInfo:userInfo);
},
...
'dart:core@Uri@toFilePath': (m.Scope scope, Uri target)=>target.toFilePath,
'dart:core@Uri@==': (m.Scope scope, Uri target)=>(other)=> target == other,
...
'dart:core@Uri@removeFragment': (m.Scope scope, Uri target)=>target.removeFragment,
'dart:core@Uri@resolve': (m.Scope scope, Uri target)=>target.resolve,
'dart:core@Uri@resolveUri': (m.Scope scope, Uri target)=>target.resolveUri,
'dart:core@Uri@normalizePath': (m.Scope scope, Uri target)=>target.normalizePath,
...
'dart:core@Uri@encodeQueryComponent': (m.Scope scope)=>Uri.encodeQueryComponent,
'dart:core@Uri@decodeComponent': (m.Scope scope)=>Uri.decodeComponent,
'dart:core@Uri@decodeQueryComponent': (m.Scope scope)=>Uri.decodeQueryComponent,
...
'dart:core@UriData@mimeType': (m.Scope scope, UriData target)=>target.mimeType,
'dart:core@UriData@charset': (m.Scope scope, UriData target)=>target.charset,
'dart:core@UriData@isBase64': (m.Scope scope, UriData target)=>target.isBase64,
'dart:core@UriData@contentText': (m.Scope scope, UriData target)=>target.contentText,
'dart:core@UriData@parameters': (m.Scope scope, UriData target)=>target.parameters,
...
'dart:core@UriData@isMimeType': (m.Scope scope, UriData target)=>target.isMimeType,
'dart:core@UriData@isCharset': (m.Scope scope, UriData target)=>target.isCharset,
'dart:core@UriData@isEncoding': (m.Scope scope, UriData target)=>target.isEncoding,
'dart:core@UriData@contentAsBytes': (m.Scope scope, UriData target)=>target.contentAsBytes,
'dart:core@UriData@contentAsString': (m.Scope scope, UriData target)=>target.contentAsString,
'dart:core@UriData@toString': (m.Scope scope, UriData target)=>target.toString,
...
'dart:core@Expando@': (m.Scope scope)=>([String? name]){
if(name == null){
return Expando();
}
return Expando(name!);
},
'dart:core@Expando@toString': (m.Scope scope, Expando target)=>target.toString,
'dart:core@Expando@[]': (m.Scope scope, Expando target)=>(index)=> target[index],
'dart:core@Expando@[]=': (m.Scope scope, Expando target)=>(index,other)=> target[index] = other,
...
'dart:core@Finalizer@attach': (m.Scope scope, Finalizer target)=>target.attach,
'dart:core@Finalizer@detach': (m.Scope scope, Finalizer target)=>target.detach,

...
class GalleryLocalizationsUr extends GalleryLocalizations {
  ...
  @override
  String get demoMenuDescription => 'مینیو عارضی سطح پر انتخابات کی ایک فہرست ڈسپلے کرتا ہے۔ یہ اس وقت ظاہر ہوتے ہیں جب صارفین بٹن، ایکشن یا دیگر کنٹرول کے ساتھ تعامل کرتے ہیں۔';
  ...
  @override
  String get demoMenuAnItemWithAContextMenuButton => 'سیاق و سباق کے مینیو والا ایک آئٹم';

  @override
  String get demoMenuContextMenuItemOne => 'سیاق و سباق کے مینیو والا پہلا آئٹم';

  @override
  String get demoMenuADisabledMenuItem => 'مینیو آئٹم غیر فعال کر دیا گیا';

  @override
  String get demoMenuContextMenuItemThree => 'سیاق و سباق کے مینیو والا تیسرا آئٹم';

  @override
  String get demoMenuAnItemWithASectionedMenu => 'سیکشن کردہ مینیو والا ایک آئٹم';
  ...
  @override
  String get demoCupertinoContextMenuSubtitle => 'iOS طرز کے سیاق و سباق کا مینیو';

  @override
  String get demoCupertinoContextMenuDescription => 'ایک iOS طرز کا فُل اسکرین سیاق و سباق کا مینیو جو اس وقت ظاہر ہوتا ہے جب کسی عنصر کو لانگ پریس کیا جاتا ہے۔';
  ...
  @override
  String get demoCupertinoContextMenuActionText => 'سیاق و سباق کا مینیو دیکھنے کے لیے فلوٹر لوگو کو تھپتھپائیں اور دبائے رکھیں۔';
  ...
  @override
  String get demoCupertinoPickerDescription => 'iOS کی طرز پر منتخب کرنے والا ویجیٹ جسے اسٹرنگز، تواریخ، اوقات یا تاریخ اور وقت دونوں کو منتخب کرنے کے لیے استعمال کیا جا سکتا ہے۔';
  ...
  @override
  String get demoCupertinoSearchTextFieldSubtitle => 'iOS طرز کا ٹیکسٹ تلاش کرنے کا فیلڈ';

  @override
  String get demoCupertinoSearchTextFieldDescription => 'ایک ٹیکسٹ تلاش کرنے کا فیلڈ جو صارف کو ٹیکسٹ درج کر کے تلاش کرنے کی اجازت دیتا ہے اور جو تجاویز پیش اور فلٹر کر سکتا ہے۔';
  ...
  @override
  String get demoCupertinoScrollbarDescription => 'ہوم پیج میں دکھائی دینے والا اسکرول بار';
  ...
  @override
  String get demoBottomSheetModalDescription => 'نیچے کی موڈل شیٹ مینیو یا ڈائیلاگ کا متبادل ہے اور صارف کو باقی ایپ کے ساتھ تعامل کرنے سے روکتی ہے۔';

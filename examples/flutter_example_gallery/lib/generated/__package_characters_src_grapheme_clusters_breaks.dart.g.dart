...
'package:characters/src/grapheme_clusters/breaks.dart@Breaks@': (m.Scope scope)=>( base,  cursor,  end,  state){
...
'package:characters/src/grapheme_clusters/breaks.dart@BackBreaks@': (m.Scope scope)=>( base,  cursor,  start,  state){
